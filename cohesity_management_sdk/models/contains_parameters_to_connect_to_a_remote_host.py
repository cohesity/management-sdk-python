...
class ContainsParametersToConnectToARemoteHost(object):

    """Implementation of the 'Contains parameters to connect to a remote host.' model.
    ...
    def __init__(self,
                 ...
                 host_address=None,
                 host_type=None):
        """Constructor for the ContainsParametersToConnectToARemoteHost class"""
