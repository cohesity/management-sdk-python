...
import cohesity_management_sdk.models.restore_protection_job_index_and_snapshots
import cohesity_management_sdk.models.unique_global_id

class CreateRemoteVaultRestoreTaskRequest(object):

    """Implementation of the 'Create Remote Vault Restore Task Request.' model.
    ...
    Attributes:
        ...
        restore_objects (list of RestoreProtectionJobIndexAndSnapshots): Array
            of Restore Objects.  Specifies the list of Snapshots and the index
            to be restored from the remote Vault. The data on the remote Vault
            may have been originally archived from multiple remote Clusters.
    ...
    def __init__(self,
        ...
        """Constructor for the CreateRemoteVaultRestoreTaskRequest class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('restoreObjects') != None:
            ...
            for structure in dictionary.get('restoreObjects'):
                restore_objects.append(cohesity_management_sdk.models.restore_protection_job_index_and_snapshots.RestoreProtectionJobIndexAndSnapshots.from_dictionary(structure))
