...
class SupportedErasureCodingAndNodeConfigurations(object):

    """Implementation of the 'Supported Erasure Coding and Node Configurations.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the SupportedErasureCodingAndNodeConfigurations class"""
