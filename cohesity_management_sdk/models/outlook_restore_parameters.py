...
class OutlookRestoreParameters(object):
    ...
    Attributes:
        ...
        target_mailbox (ProtectionSource): Specifies the destination mailbox
            where the mailboxes specified within OutlookMailboxes will be
            restored with their appropriate names.
    """
