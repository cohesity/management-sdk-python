    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('requiredPropertyVec') != None:
            ...
            for structure in dictionary.get('requiredPropertyVec'):
                required_property_vec.append(cohesity_management_sdk.models.map_reduce_info_required_property.MapReduceInfo_RequiredProperty.from_dictionary(structure))
