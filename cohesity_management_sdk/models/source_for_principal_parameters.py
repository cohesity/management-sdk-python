...
class SourceForPrincipalParameters(object):

    """Implementation of the 'Source for Principal Parameters.' model.
    ...
    def __init__(self,
                 ...
                 sid=None,
                 view_names=None):
        """Constructor for the SourceForPrincipalParameters class"""
