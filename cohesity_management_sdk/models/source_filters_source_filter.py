...
class SourceFilters_SourceFilter(object):
    ...
    Wildcard filter: { source_filter: "Test?Database*", is_regex: false}. Regex
    filter: { source_filter: "^Test.*Database$", is_regex: true}.
    ...
    Attributes:
        ...
        case_sensitive (bool): Determines if the filter is case sensitive or
            ...
            environments (e.g. VMware), the default will be based on the
