...
class SetupRestoreDiskTaskInfoProto(object):
    ...
    =============================================================================
    vmware::SetupRestoreDiskTaskInfo vmware_setup_restore_disk_task_info, 100
    connectors/vmware/vmware_setup_restore_disks.proto.proto 
    AgentSetupRestoreDiskTaskInfo agent_setup_restore_disk_task_info, 101
    base/agent.proto  app_file::SetupRestoreTaskInfo
    app_file_setup_restore_task_info, 102
    connectors/app_file/app_file_setup_restore.proto 
    hyperv::SetupRestoreDiskTaskInfo hyperv_setup_restore_disk_task_info, 103
    ...
    Attributes:
        ...
        entity (EntityProto): The entity on which disks will be setup.
        progress_monitor_root_task_path (string): The path to the progress
            monitor root task if any.
        root_entity (EntityProto): The root entity that the entity was running
            under.
