...
import cohesity_management_sdk.models.s_3_bucket_config_proto_tag_map_entry
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('tagMap') != None:
            ...
            for structure in dictionary.get('tagMap'):
                tag_map.append(cohesity_management_sdk.models.s_3_bucket_config_proto_tag_map_entry.S3BucketConfigProto_TagMapEntry.from_dictionary(structure))
