...
class SalesforceAccountInformation(object):

    """Implementation of the 'Salesforce Account Information.' model.
    ...
    def __init__(self,
                 account_id=None,
                 user_id=None):
        """Constructor for the SalesforceAccountInformation class"""
