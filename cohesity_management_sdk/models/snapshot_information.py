...
class SnapshotInformation(object):

    """Implementation of the 'Snapshot Information.' model.

    Specifies details about the snapshot task created to backup or copy one
    source object like a VM.

    Attributes:
        environment (Environment7Enum): Specifies the environment type (such
            as kVMware or kSQL) that contains the source to backup. Supported
    ...
    def __init__(self,
                 ...
                 root_path=None,
                 view_name=None):
        """Constructor for the SnapshotInformation class"""
