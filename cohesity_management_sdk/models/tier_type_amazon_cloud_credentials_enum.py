...
class TierTypeAmazonCloudCredentialsEnum(object):

    """Implementation of the 'TierTypeAmazonCloudCredentials' enum.
    ...
    patterns. 'kAmazonS3Glacier' indicates a tier type of Amazon properties for
    ...
    for data that provides secure, durable object storage for long-term data
