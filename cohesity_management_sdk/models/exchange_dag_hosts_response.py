...
class ExchangeDagHostsResponse(object):
    ...
    Attributes:
        ...
        is_standalone_host (bool): Specifies if the endpoint provided in the
            request is a standlone exchange server or not. exchangeHostInfoList
            is not populated if it is a standalone exchange server.
        name (string): Specifies the display name of the DAG.
        protection_source_id (long|int): Specifies the Protection Source Id of
            the Exchange DAG if it is already created.
    """
