...
class UpdateProtectionJobRunsParameters(object):

    """Implementation of the 'Update Protection Job Runs Parameters.' model.
    ...
    def __init__(self,
                 job_runs=None):
        """Constructor for the UpdateProtectionJobRunsParameters class"""
