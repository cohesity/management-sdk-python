...
class RemoteVaultSearchJobResult(object):

    """Implementation of the 'Remote Vault Search Job Result.' model.
    ...
    Attributes:
        ...
        protection_jobs (list of RemoteProtectionJobRunInformation): Array of
            ...
            criteria.
        search_job_status (SearchJobStatus1Enum): Specifies the status of the
            search Job. 'kJobRunning' indicates that the Job/task is currently
    ...
    def __init__(self,
                 ...
                 vault_id=None,
                 vault_name=None):
        """Constructor for the RemoteVaultSearchJobResult class"""
