...
import cohesity_management_sdk.models.input_spec_input_v_ms_selector

class InputSelectorSelectsTheFilesToMapOver(object):

    """Implementation of the 'Input selector. Selects the files to map over.' model.

    TODO: type model description here.

    Attributes:
        files_selector (InputSpecInputFilesSelector): If mapper is going to
            run over files on SnapFS, this selects the input files.
        on_nfs_files (bool): Selects whether input is files inside vmdks or
            ...
            based on this flag.
        vm_selector (InputSpecInputVMsSelector): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 on_nfs_files=None,
                 vm_selector=None):
        """Constructor for the InputSelectorSelectsTheFilesToMapOver class"""
    ...
    def from_dictionary(cls,
        ...
        vm_selector = cohesity_management_sdk.models.input_spec_input_v_ms_selector.InputSpecInputVMsSelector.from_dictionary(dictionary.get('vmSelector')) if dictionary.get('vmSelector') else None
