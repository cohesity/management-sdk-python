...
class ApplicationSpecialJobParameters(object):

    """Implementation of the 'Application Special Job Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ApplicationSpecialJobParameters class"""
