...
class CancelAProtectionJobRun(object):

    """Implementation of the 'Cancel a Protection Job Run.' model.

    TODO: type model description here.

    Attributes:
        copy_task_uid (UniqueGlobalId): Specifies an id for an object that is
    ...
    def __init__(self,
                 copy_task_uid=None,
                 job_run_id=None):
        """Constructor for the CancelAProtectionJobRun class"""
    ...
    def from_dictionary(cls,
        ...
        copy_task_uid = cohesity_management_sdk.models.unique_global_id.UniqueGlobalId.from_dictionary(dictionary.get('copyTaskUid')) if dictionary.get('copyTaskUid') else None
