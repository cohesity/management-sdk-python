...
class CreateRemoteVaultSearchRequest(object):

    """Implementation of the 'Create Remote Vault Search Request.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CreateRemoteVaultSearchRequest class"""
