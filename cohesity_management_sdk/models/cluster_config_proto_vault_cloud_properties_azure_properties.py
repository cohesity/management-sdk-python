...
class ClusterConfigProto_Vault_CloudProperties_AzureProperties(object):
    ...
    Attributes:
        ...
        worm_enabled (bool): Indicates whether write once read many (WORM)
            ...
            the following fields must be populated in CloudCredentials.
            Microsoft in order to query the immutability policy duration of an
            Azure container: resource_group, subscription_id, application_id,
