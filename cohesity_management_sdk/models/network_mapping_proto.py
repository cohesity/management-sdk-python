...
class NetworkMappingProto(object):
    ...
    Attributes:
        ...
        disable_network (bool): This can be set to true to indicate that the
            attached network should be left in disabled state. This value takes
        ...
        source_network_entity (EntityProto): The network entity (i.e, either a
            standard switch port group or a distributed port group in a VMware
            env) that is attached to one of the source object.
        target_network_entity (EntityProto): The network entity (i.e, either a
            standard switch port group or a distributed port group in a VMware
            env) that will be attached to one of the target object.
    """
