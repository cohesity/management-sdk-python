...
class UsageAndPerformanceStatistics(object):

    """Implementation of the 'Usage and Performance Statistics' model.
    ...
    def __init__(self,
        ...
        """Constructor for the UsageAndPerformanceStatistics class"""
