...
class GetViewsAndAliasesByShareResult(object):

    """Implementation of the 'Get (Views and Aliases) By Share Result.' model.
    ...
    def __init__(self,
                 ...
                 shares_list=None):
        """Constructor for the GetViewsAndAliasesByShareResult class"""
