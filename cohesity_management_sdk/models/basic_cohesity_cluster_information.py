...
class BasicCohesityClusterInformation(object):

    """Implementation of the 'Basic Cohesity Cluster Information.' model.

    Specifies basic information about the Cohesity Cluster.

    Attributes:
        authentication_type (int): Specifies the authentication scheme for the
            cluster.
    ...
    def __init__(self,
                 ...
                 name=None):
        """Constructor for the BasicCohesityClusterInformation class"""
