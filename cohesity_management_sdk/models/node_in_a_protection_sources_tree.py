...
class NodeInAProtectionSourcesTree(object):

    """Implementation of the 'Node in a Protection Sources Tree.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the NodeInAProtectionSourcesTree class"""
