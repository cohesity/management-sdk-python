...
class JobPolicyProto(object):
    ...
    Attributes:
        ...
        backup_policy (BackupPolicyProto): Specifies the scheduling and
            retention policy to use when backing up sources.
        snapshot_target_policy_vec (list of SnapshotTargetPolicyProto):
            ...
            replica, tape etc). Each policy also specifies the retention policy
            that should be applied to the copied snapshots at the respective
            target.
    """
