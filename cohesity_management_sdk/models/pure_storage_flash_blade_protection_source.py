...
class PureStorageFlashBladeProtectionSource(object):

    """Implementation of the 'Pure Storage FlashBlade Protection Source.' model.
    ...
    Attributes:
        ...
        mtype (Type3Enum): Specifies the type of managed object in a Pure
            Storage FlashBlade like 'kStorageArray' or 'kFileSystem'.
            'kStorageArray' indicates a top level Pure Storage FlashBlade
            array. 'kFileSystem' indicates a Pure Storage FlashBlade file
            system within the array.
    ...
    def __init__(self,
                 ...
                 storage_array=None,
                 mtype=None):
        """Constructor for the PureStorageFlashBladeProtectionSource class"""
