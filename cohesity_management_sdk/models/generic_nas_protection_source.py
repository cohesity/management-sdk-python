...
class GenericNASProtectionSource(object):
    ...
    Attributes:
        ...
        protocol (Protocol2Enum): Specifies the protocol used by the NAS
        ...
        skip_validation (bool): Specifies whether to skip validation of the
            given mount point.
        mtype (Type10Enum): Specifies the type of a Protection Source Object
            in a generic NAS Source such as 'kGroup', or 'kHost'. Specifies
            the kind of NAS mount. 'kGroup' indicates top level node that
            holds individual NAS hosts. 'kHost' indicates a single NAS path
            that can be mounted. 'kDfsGroup' indicates a DFS group containing
            top level directories mapped to different servers. 'kDfsTopDir'
            indicates a top level directory inside a DFS group, discovered
            when registering a DFS group.
