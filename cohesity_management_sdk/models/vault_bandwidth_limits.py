...
class VaultBandwidthLimits(object):
    ...
    Attributes:
        ...
        cloud_tier_download (BandwidthLimit): Specifies the max rate limit at
            which we download the data to cloud tier vaults.
        cloud_tier_upload (BandwidthLimit): Specifies the max rate limit at
            which we upload the data to cloud tier vaults.
        download (BandwidthLimit): Specifies the max rate limit at which we
            download the data.
        upload (BandwidthLimit): Specifies the max rate limit at which we
            upload the data.
    """
