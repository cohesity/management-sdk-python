...
class RPOPolicy(object):

    """Implementation of the 'RPO Policy.' model.
    ...
    Attributes:
        ...
        environment_type_job_params (EnvironmentSpecificCommonJobParameters):
        ...
        qos_type (QosType1Enum): Specifies the QoS policy type to use.
            'kBackupHDD' indicates the Cohesity Cluster writes data directly
            to the HDD tier for this Protection Job. This is the recommended
            setting. 'kBackupSSD' indicates the Cohesity Cluster writes data
            directly to the SSD tier for this Protection Job. Only specify
            this policy if you need fast ingest speed for a small number of
            Protection Jobs.
    ...
    def __init__(self,
        ...
        """Constructor for the RPOPolicy class"""
    ...
    def from_dictionary(cls,
        ...
        environment_type_job_params = cohesity_management_sdk.models.environment_specific_common_job_parameters.EnvironmentSpecificCommonJobParameters.from_dictionary(dictionary.get('environmentTypeJobParams')) if dictionary.get('environmentTypeJobParams') else None
