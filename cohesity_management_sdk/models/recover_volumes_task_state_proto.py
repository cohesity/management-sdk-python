...
class RecoverVolumesTaskStateProto(object):
    ...
    Attributes:
        ...
        params (RecoverVolumesParams): Captures the original parameters from
            Iris.
        task_result_vec (list of RecoverVolumesTaskStateProto_TaskResult):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('taskResultVec') != None:
            ...
            for structure in dictionary.get('taskResultVec'):
                task_result_vec.append(cohesity_management_sdk.models.recover_volumes_task_state_proto_task_result.RecoverVolumesTaskStateProto_TaskResult.from_dictionary(structure))
