...
import cohesity_management_sdk.models.office365_site_info
import cohesity_management_sdk.models.office365_team_info
import cohesity_management_sdk.models.office365_user_info
...
class Office365ProtectionSource(object):
    ...
    def from_dictionary(cls,
        ...
        site_info = cohesity_management_sdk.models.office365_site_info.Office365SiteInfo.from_dictionary(dictionary.get('siteInfo')) if dictionary.get('siteInfo') else None
        team_info = cohesity_management_sdk.models.office365_team_info.Office365TeamInfo.from_dictionary(dictionary.get('teamInfo')) if dictionary.get('teamInfo') else None
        mtype = dictionary.get('type')
        user_info = cohesity_management_sdk.models.office365_user_info.Office365UserInfo.from_dictionary(dictionary.get('userInfo')) if dictionary.get('userInfo') else None
