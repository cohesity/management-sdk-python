...
import cohesity_management_sdk.models.protection_information
...
class ObjectInformation(object):
    ...
    Attributes:
        ...
        protection_info (list of ProtectionInformation): Specifies the data
            locations for the protected objects.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('protectionInfo') != None:
            ...
            for structure in dictionary.get('protectionInfo'):
                protection_info.append(cohesity_management_sdk.models.protection_information.ProtectionInformation.from_dictionary(structure))
