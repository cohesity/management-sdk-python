...
class ProductModelAndInterfaceTuple(object):

    """Implementation of the 'Product model and interface tuple.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ProductModelAndInterfaceTuple class"""
