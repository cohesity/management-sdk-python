...
class OutlookEnvironmentJobParameters(object):

    """Implementation of the 'Outlook Environment Job Parameters.' model.
    ...
    Attributes:
        file_path_filter (FileOrDirectoryPathFilter): Specifies filters to
    ...
    def __init__(self,
        ...
        """Constructor for the OutlookEnvironmentJobParameters class"""
    ...
    def from_dictionary(cls,
        ...
        file_path_filter = cohesity_management_sdk.models.file_or_directory_path_filter.FileOrDirectoryPathFilter.from_dictionary(dictionary.get('filePathFilter')) if dictionary.get('filePathFilter') else None
