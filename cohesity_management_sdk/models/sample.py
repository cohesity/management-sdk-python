...
class Sample(object):
    ...
    Attributes:
        ...
        float_value (float): Specifies the value of the data sample if the type
            is float64. This field is nil if the type of the data is not a
            float value.
        timestamp_msecs (long|int): Specifies the timestamp when the data
            sample occured.
        value (long|int): Specifies the value of the data sample if the type is
            int64. This field is nil if the type of the data is not an int
            value.
    """
