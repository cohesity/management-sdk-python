...
class PatternTypeEnum(object):
    ...
    TODO(Tauseef): Amend the PatternType to be kRegular & KTemplate. Future
    Pattern Types to be added here.
    'REGULAR' indicates that the pattern contains a regular expression.
    'TEMPLATE' indicates that the pattern has a pre defined input pattern such
    as
