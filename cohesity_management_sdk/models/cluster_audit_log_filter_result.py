...
class ClusterAuditLogFilterResult(object):

    """Implementation of the 'Cluster Audit Log Filter Result.' model.
    ...
    def __init__(self,
                 ...
                 total_count=None):
        """Constructor for the ClusterAuditLogFilterResult class"""
