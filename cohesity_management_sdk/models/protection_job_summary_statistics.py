...
class ProtectionJobSummaryStatistics(object):

    """Implementation of the 'Protection Job Summary Statistics.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ProtectionJobSummaryStatistics class"""
