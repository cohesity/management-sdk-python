...
class FileFolderSearchResult(object):

    """Implementation of the 'File/Folder Search Result.' model.
    ...
    Attributes:
        ...
        job_uid (UniqueGlobalId): Specifies the universal id of the Protection
        ...
        mtype (Type27Enum): Specifies the type of the file document such as
            KDirectory, kFile, etc.
    ...
    def __init__(self,
                 ...
                 mtype=None,
                 view_box_id=None):
        """Constructor for the FileFolderSearchResult class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('fileVersions') != None:
            ...
            for structure in dictionary.get('fileVersions'):
                file_versions.append(cohesity_management_sdk.models.file_folder_version.FileFolderVersion.from_dictionary(structure))
