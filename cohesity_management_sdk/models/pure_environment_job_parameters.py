...
class PureEnvironmentJobParameters(object):

    """Implementation of the 'Pure Environment Job Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PureEnvironmentJobParameters class"""
