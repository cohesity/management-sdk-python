...
class ApplicationsRestoreTaskRequest(object):
    ...
    Attributes:
        ...
        application_environment (ApplicationEnvironmentEnum, required):
        ...
        hosting_protection_source (RestoreObjectDetails, required): Specifies
            ...
            ProtectionSourceAndApplicationRestoreObjects. deprecated: true
        name (string, required): Specifies a name for the new task to be
            created. This field has to be set, and it needs to be unique across
            all restore tasks.
