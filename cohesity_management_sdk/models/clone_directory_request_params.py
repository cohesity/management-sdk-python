...
class CloneDirectoryRequestParams(object):

    """Implementation of the 'Clone Directory Request Params.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CloneDirectoryRequestParams class"""
