...
class SSLCertificateConfiguration(object):

    """Implementation of the 'SSL Certificate Configuration.' model.
    ...
    def __init__(self,
                 ...
                 private_key=None):
        """Constructor for the SSLCertificateConfiguration class"""
