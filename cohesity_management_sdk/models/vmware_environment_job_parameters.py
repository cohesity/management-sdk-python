...
class VmwareEnvironmentJobParameters(object):

    """Implementation of the 'Vmware Environment Job Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VmwareEnvironmentJobParameters class"""
