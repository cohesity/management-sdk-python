...
import cohesity_management_sdk.models.vmware_source_special_job_parameters

class SourceSpecialParameters(object):

    """Implementation of the 'Source Special Parameters.' model.
    ...
    Attributes:
        oracle_special_parameters (ApplicationSpecialJobParameters): Specifies
            additional special settings applicable for a Protection Source of
            'kSQL'/'kOracle' type in a Protection Job.
        physical_special_parameters (PhysicalSourceSpecialJobParameters):
            Specifies additional special settings applicable for a Protection
            Source of 'kPhysical' type in a Protection Job.
        ...
        sql_special_parameters (ApplicationSpecialJobParameters): Specifies
            additional special settings applicable for a Protection Source of
            'kSQL'/'kOracle' type in a Protection Job.
        ...
        vmware_special_parameters (VmwareSourceSpecialJobParameters):
            Specifies additional special settings applicable for a Protection
            Source of 'kVMware' type in a Protection Job.
    ...
    def __init__(self,
        ...
        """Constructor for the SourceSpecialParameters class"""
    ...
    def from_dictionary(cls,
        ...
        oracle_special_parameters = cohesity_management_sdk.models.application_special_job_parameters.ApplicationSpecialJobParameters.from_dictionary(dictionary.get('oracleSpecialParameters')) if dictionary.get('oracleSpecialParameters') else None
        physical_special_parameters = cohesity_management_sdk.models.physical_source_special_job_parameters.PhysicalSourceSpecialJobParameters.from_dictionary(dictionary.get('physicalSpecialParameters')) if dictionary.get('physicalSpecialParameters') else None
        skip_indexing = dictionary.get('skipIndexing')
        source_id = dictionary.get('sourceId')
        sql_special_parameters = cohesity_management_sdk.models.application_special_job_parameters.ApplicationSpecialJobParameters.from_dictionary(dictionary.get('sqlSpecialParameters')) if dictionary.get('sqlSpecialParameters') else None
        ...
        vmware_special_parameters = cohesity_management_sdk.models.vmware_source_special_job_parameters.VmwareSourceSpecialJobParameters.from_dictionary(dictionary.get('vmwareSpecialParameters')) if dictionary.get('vmwareSpecialParameters') else None

        # Return an object of this model
        return cls(oracle_special_parameters,
