...
class AdditionalOracleDBParams(object):
    ...
    Attributes:
        ...
        db_info_channel_vec (list of OracleDBChannelInfo): The following proto
            ...
            It is a vector for future support of backing up Data Guard sources.
            We may or may not need this to be vector to support Data Guard
            sources. For now, the size of this vector is always 1. When we
            rename this proto in the future, if we determine there is no need
            to use a vector for Data Guard support, we can choose to remove
            'repeated'.
    """
