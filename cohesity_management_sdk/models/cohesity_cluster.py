...
import cohesity_management_sdk.models.athena_apps_configuration
import cohesity_management_sdk.models.cluster_audit_log_configuration
import cohesity_management_sdk.models.eula_configuration
import cohesity_management_sdk.models.filer_audit_log_configuration
import cohesity_management_sdk.models.cohesity_cluster_hardware
import cohesity_management_sdk.models.ntp_settings_config
import cohesity_management_sdk.models.cohesity_cluster_statistics
import cohesity_management_sdk.models.supported_erasure_coding_and_node_configurations
import cohesity_management_sdk.models.syslog_server_configuration

class CohesityCluster(object):

    """Implementation of the 'Cohesity Cluster.' model.

    Specifies information about the Cohesity Cluster.

    Attributes:
        apps_settings (AthenaAppsConfiguration): TODO: type description here.
        ...
        cluster_type (ClusterType1Enum): Specifies the type of Cluster such as
        ...
        eula_config (EULAConfiguration): Specifies the End User License
            Agreement (EULA) acceptance information.
        ...
        google_analytics_enabled (bool): Specified whether Google Analytics is
            enabled.
        hardware_info (CohesityClusterHardware): Specifies a hardware type for
        ...
        stats (CohesityClusterStatistics): Specifies statistics about this
            Cohesity Cluster.
        stig_mode (bool): Specifies if STIG mode is enabled or not.
        supported_config (SupportedErasureCodingAndNodeConfigurations): Lists
            the supported Erasure Coding options for the number of Nodes in
            the Cohesity Cluster. In addition, the minimum number of Nodes
            supported for this Cluster type is defined.
        syslog_servers (list of SyslogServerConfiguration): Array of Syslog
            Servers.  Specifies a list of Syslog servers to send audit logs
            to.
    ...
    def __init__(self,
        ...
        """Constructor for the CohesityCluster class"""
    ...
    def from_dictionary(cls,
        ...
        apps_settings = cohesity_management_sdk.models.athena_apps_configuration.AthenaAppsConfiguration.from_dictionary(dictionary.get('appsSettings')) if dictionary.get('appsSettings') else None
        ...
        eula_config = cohesity_management_sdk.models.eula_configuration.EULAConfiguration.from_dictionary(dictionary.get('eulaConfig')) if dictionary.get('eulaConfig') else None
        ...
        hardware_info = cohesity_management_sdk.models.cohesity_cluster_hardware.CohesityClusterHardware.from_dictionary(dictionary.get('hardwareInfo')) if dictionary.get('hardwareInfo') else None
        ...
        stats = cohesity_management_sdk.models.cohesity_cluster_statistics.CohesityClusterStatistics.from_dictionary(dictionary.get('stats')) if dictionary.get('stats') else None
        stig_mode = dictionary.get('stigMode')
        supported_config = cohesity_management_sdk.models.supported_erasure_coding_and_node_configurations.SupportedErasureCodingAndNodeConfigurations.from_dictionary(dictionary.get('supportedConfig')) if dictionary.get('supportedConfig') else None
        syslog_servers = None
        if dictionary.get('syslogServers') != None:
            syslog_servers = list()
            for structure in dictionary.get('syslogServers'):
                syslog_servers.append(cohesity_management_sdk.models.syslog_server_configuration.SyslogServerConfiguration.from_dictionary(structure))
