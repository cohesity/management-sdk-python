...
class StatusOfRestoreSnapshotTask(object):

    """Implementation of the 'Status of Restore Snapshot Task.' model.
    ...
    Attributes:
        ...
        snapshot_task_status (SnapshotTaskStatusEnum): Specifies the status of
            ...
            paused.
        snapshot_task_uid (UniqueGlobalId): Specifies the globally unique id
            of the task capturing the Snapshot.
    ...
    def __init__(self,
        ...
        """Constructor for the StatusOfRestoreSnapshotTask class"""
    ...
    def from_dictionary(cls,
        ...
        snapshot_task_uid = cohesity_management_sdk.models.unique_global_id.UniqueGlobalId.from_dictionary(dictionary.get('snapshotTaskUid')) if dictionary.get('snapshotTaskUid') else None
