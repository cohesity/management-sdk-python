...
class RdsParams(object):
    ...
    Attributes:
        ...
        enable_copy_tags_to_snapshots (bool): Whether to enable copying of tags
            to snapshots of the DB.
        ...
        enable_public_accessibility (bool): Whether this DB will be publicly
            accessible or not.
        is_multi_az_deployment (bool): Whether this is a multi-az deployment or
            not.
    """
