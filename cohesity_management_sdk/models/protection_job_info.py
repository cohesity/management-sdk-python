...
class ProtectionJobInfo(object):
    ...
    """Implementation of the 'Protection Job Info' model.
    ...
    Attributes:
        ...
        mtype (Type23Enum): Specifies the type of the Protection Job such as
            kView or kPuppeteer. 'kPuppeteer' refers to a Remote Adapter Job.
