...
class SpecifiesTheExternalClientSubnetsThatCanCommunicateWithThisCluster(object):

    """Implementation of the 'Specifies the external Client Subnets that can communicate with this cluster.' model.
    ...
    def __init__(self,
                 client_subnets=None):
        """Constructor for the SpecifiesTheExternalClientSubnetsThatCanCommunicateWithThisCluster class"""
