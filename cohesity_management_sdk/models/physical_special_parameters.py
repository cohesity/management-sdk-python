...
class PhysicalSpecialParameters(object):
    ...
    Attributes:
        ...
        enable_system_backup (bool): Specifies whether to allow system backup
            ...
            backups are used for doing bare metal recovery later. This field is
            applicable only for System backups.
        ...
        volume_guid (list of string): Array of Mounted Volumes to Back Up. 
            ...
            are protected.
        windows_parameters (WindowsHostSnapshotParameters): Specifies
            parameters applicable only to Windows hosts.
    """
