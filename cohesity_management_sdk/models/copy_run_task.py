...
class CopyRunTask(object):

    """Implementation of the 'Copy Run Task.' model.
    ...
    Attributes:
        ...
        status (Status4Enum): Specifies the aggregated status of copy tasks
            such as 'kRunning', 'kSuccess', 'kFailure' etc. 'kAccepted'
            ...
            the task failed.
        target (SnapshotTarget1): Specifies settings about a target where a
            copied Snapshot is stored. A target can be a Remote Cluster or an
            Archival External Target such as AWS or Tape.
        task_uid (UniqueGlobalId): Specifies a globally unique id of the copy
            task.
    ...
    def __init__(self,
        ...
        """Constructor for the CopyRunTask class"""
    ...
    def from_dictionary(cls,
        ...
        target = cohesity_management_sdk.models.snapshot_target_1.SnapshotTarget1.from_dictionary(dictionary.get('target')) if dictionary.get('target') else None
        task_uid = cohesity_management_sdk.models.unique_global_id.UniqueGlobalId.from_dictionary(dictionary.get('taskUid')) if dictionary.get('taskUid') else None
