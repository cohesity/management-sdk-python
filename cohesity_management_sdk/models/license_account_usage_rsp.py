...
class LicenseAccountUsageRsp(object):
    ...
    Attributes:
        feature_over_usage (list): Holds information about consumption usage of
            overused features.
        ...
        licensed_usage (list): LicenseFeatureUsages holds information
            about each feature from license orders.
        trial_expiration (int): Trial expiration period.
        usage (list of): Creating a map of cluster id and feature usage to
    ...
    def from_dictionary(cls,
        ...
        feature_over_usage = dictionary.get('featureOverUsage')
        ...
        licensed_usage = dictionary.get('licensedUsage')
