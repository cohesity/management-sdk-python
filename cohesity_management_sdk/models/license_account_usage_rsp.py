...
class LicenseAccountUsageRsp(object):
    ...
    Attributes:
        ...
        last12_months_avg_entitlement (object): Holds monthly avg usage values
            of feature
        last12_months_avg_usage (object): Holds monthly avg usage values of
            feature
        last30_days_entitlement (object): Holds daily entitled capacity values
            of feature
        last30_days_usage (object): Holds daily usage values of feature
