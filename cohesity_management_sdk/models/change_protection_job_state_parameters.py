...
class ChangeProtectionJobStateParameters(object):

    """Implementation of the 'Change Protection Job State Parameters.' model.
    ...
    def __init__(self,
                 pause=None,
                 pause_reason=None):
        """Constructor for the ChangeProtectionJobStateParameters class"""
