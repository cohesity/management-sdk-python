...
class CloneRestoreTaskRequest(object):

    """Implementation of the 'Clone Restore Task Request.' model.
    ...
    Attributes:
        ...
        target_view_name (string): Specifies the name of the View where the
            ...
            Restore Task.
        mtype (Type25Enum): Specifies the type of Restore Task such as
            'kCloneVMs' or 'kCloneView'. 'kCloneVMs' specifies a Restore Task
            that clones VMs. 'kCloneView' specifies a Restore Task that clones
            a View.
    ...
    def __init__(self,
        ...
        """Constructor for the CloneRestoreTaskRequest class"""
