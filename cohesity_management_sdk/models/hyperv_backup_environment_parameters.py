...
class HypervBackupEnvironmentParameters(object):

    """Implementation of the 'HyperV Backup Environment Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the HypervBackupEnvironmentParameters class"""
