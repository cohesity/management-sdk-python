...
class ExchangeDAGProtectionPreference(object):
    ...
    Specifies the information about the preference order while choosing between
    which database copy of the database which is part of DAG should be
    protected.
    ...
    Attributes:
        ...
        passive_only (bool): Specifies that only passive database copies should
            be protected if this is set to true. If this is set to false, both
            active and passive database copies can be protected.
        use_user_specified_passive_preference_order (bool): Specifies to use
            ...
            true.  Every copy of an Exchange database in a DAG is assigned an
            activation preference number. This number is used by the system as
            part of the passive database activation process. If this bool flag
            is set to false, the reverse order of activation is used while
            choosing between passive copies.
    """
    ...
    def from_dictionary(cls,
        ...
        return cls(
            passive_copy_preference_server_guid_list,
            passive_only,
