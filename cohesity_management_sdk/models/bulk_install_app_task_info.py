...
class BulkInstallAppTaskInfo(object):
    ...
    Attributes:
        ...
        num_machines_failed (int): Number of machines on which task is started.
        num_machines_passed (int): Number of machines on which task is started.
        ...
        state (StateBulkInstallAppTaskInfoEnum): Current state of the task.
            ...
            bulk install app. 'started' indicates that the job has been started
            by the user. 'completed' indicates that the job has completed.
    """
