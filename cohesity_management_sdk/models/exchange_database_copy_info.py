...
class ExchangeDatabaseCopyInfo(object):
    ...
    Attributes:
        ...
        activation_preference_number (int): Specifies the activation preference
            number assigned for this database copy.
        app_server_id (long|int): Specifies the entity id of the Exchange
        ...
        created_time_msecs (long|int): Specifies the time when the database is
            created in Unix epoch time in milliseconds.
        database_state (DatabaseStateEnum): Specifies the state of the Exchange
            database copy. Specifies the state of Exchange Database Copy.  
            'kUnknown' indicates the status is not known. 'kMounted' indicates
            the exchange database copy is mounted and healthy. 'kError'
            indicates  the  exchange  database  copy  is unmounted or partially
            mounted or is in error state.
        db_size_bytes (long|int): Specifies the size of the Exchange database
            copy in bytes.
        ...
        owner_id (long|int): Specifies the owner entity id of the Exchange
            Application Server which has this database copy.
        server_name (string): Specifies the display name of the Exchange
            Application Server on which the database copy is hosted.
        utc_offset_min (long|int): Specifies UTC time offset of database
            creation time.
    """
