...
class HostInfo(object):
    ...
    Attributes:
        ...
        password (string): Specifies the password of the host to establish SSH
            connection. The certificate is copied to the host after generating
            the certificate on the cluster.
