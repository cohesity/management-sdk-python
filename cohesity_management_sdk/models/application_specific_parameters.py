...
class ApplicationSpecificParameters(object):

    """Implementation of the 'Application specific parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ApplicationSpecificParameters class"""
