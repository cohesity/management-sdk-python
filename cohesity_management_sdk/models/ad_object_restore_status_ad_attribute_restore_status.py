...
class ADObjectRestoreStatus_ADAttributeRestoreStatus(object):
    ...
    Attributes:
        ...
        attrstatus_vec (list of ErrorProto): Error status. If the
            'attrstatus_vec' is empty or contains kNoError, treat the attribute
            restore as success. For multi-valued properties such as 'memberOf',
            this vector may contain failure to add or remove specific value
            within the multi-value set.
    ...
    def __init__(self,
        ...
        """Constructor for the ADObjectRestoreStatus_ADAttributeRestoreStatus class"""
