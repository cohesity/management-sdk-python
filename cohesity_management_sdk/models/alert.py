...
import cohesity_management_sdk.models.alert_key_value_pair
...
class Alert(object):
    ...
    Attributes:
        ...
        property_list (list of AlertKeyValuePair): Specifies array of
            key-value pairs associated with the Alert. The Cohesity Cluster
            may autogenerate properties depending on the Alert type. This list
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('propertyList') != None:
            ...
            for structure in dictionary.get('propertyList'):
                property_list.append(cohesity_management_sdk.models.alert_key_value_pair.AlertKeyValuePair.from_dictionary(structure))
