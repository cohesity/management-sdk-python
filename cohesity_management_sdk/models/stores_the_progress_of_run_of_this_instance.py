...
class StoresTheProgressOfRunOfThisInstance(object):

    """Implementation of the 'Stores the progress of run of this instance.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the StoresTheProgressOfRunOfThisInstance class"""
