...
import cohesity_management_sdk.models.mounting_volumes
...
class CreateRestoreTaskRequest(object):

    """Implementation of the 'Create Restore Task Request.' model.
    ...
    Attributes:
        ...
        mount_parameters (MountingVolumes): Specifies the information required
            for mounting volumes. Only required for Restore Tasks of type
            'kMountVolumes'. At a minimum, the targetSourceId must be
        ...
        restore_view_parameters (View1): Specifies the settings that define a
            View.
        mtype (Type30Enum): Specifies the type of Restore Task such as
            'kRecoverVMs' or 'kMountVolumes'. 'kRecoverVMs' specifies a
            Restore Task that recovers VMs. 'kMountVolumes' specifies a
    ...
    def __init__(self,
        ...
        """Constructor for the CreateRestoreTaskRequest class"""
    ...
    def from_dictionary(cls,
        ...
        mount_parameters = cohesity_management_sdk.models.mounting_volumes.MountingVolumes.from_dictionary(dictionary.get('mountParameters')) if dictionary.get('mountParameters') else None
        ...
        restore_view_parameters = cohesity_management_sdk.models.view_1.View1.from_dictionary(dictionary.get('restoreViewParameters')) if dictionary.get('restoreViewParameters') else None
