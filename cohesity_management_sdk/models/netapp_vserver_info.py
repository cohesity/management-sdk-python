...
class NetappVserverInfo(object):
    ...
    Attributes:
        ...
        root_cifs_share (CifsShareInfo): Specifies the root 'c$' CIFS share of
            this Vserver. If it exists, it can be used to mount all CIFS
            volumes that are junctioned under '/' on this Vserver.
        mtype (TypeNetappVserverInfoEnum): Specifies the type of this Vserver.
            ...
            Vserver is used for data backup and restore. 'kAdmin' indicates the
            Vserver is used for cluster-wide management. 'kSystem' indicates
            the Vserver is used for cluster-scoped communications in an
            IPspace. 'kNode' indicates the Vserver is used as the physical
