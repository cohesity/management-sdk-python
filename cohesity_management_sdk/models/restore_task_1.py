...
import cohesity_management_sdk.models.virtual_disk_recover_state
import cohesity_management_sdk.models.vlan_parameters
import cohesity_management_sdk.models.vmware_restore_parameters

class RestoreTask1(object):

    """Implementation of the 'Restore Task.1' model.
    ...
    Attributes:
        acropolis_parameters (AcropolisRestoreParameters): This field defines
            ...
            kRecoverVMs.
        archive_task_uid (UniqueGlobalId): Specifies the uid of the Restore
            Task that retrieves objects from an archive. This field is only
            populated when objects must be retrieved from an archive before
            being restored.
        clone_view_parameters (View1): Specifies the View settings used when
            cloning a View.
        ...
        error (Error): Specifies the error reported by the Restore Task (if
            any) after the Task has finished.
        ...
        id (long|int): Specifies the id of the Restore Task assigned by
            Cohesity Cluster.
        mount_volumes_state (MountVolumesStates): Specifies the states of
        ...
        status (Status6Enum): Specifies the overall status of the Restore
            Task. 'kReadyToSchedule' indicates the Restore Task is waiting to
            be scheduled. 'kProgressMonitorCreated' indicates the progress
        ...
        target_view_created (bool): Is true if a new View was created by a
            ...
            Restore Task.
        mtype (Type32Enum): Specifies the type of Restore Task.  'kRecoverVMs'
            specifies a Restore Task that recovers VMs. 'kCloneVMs' specifies
            a Restore Task that clones VMs. 'kCloneView' specifies a Restore
            Task that clones a View. 'kMountVolumes' specifies a Restore Task
            that mounts volumes. 'kRestoreFiles' specifies a Restore Task that
            recovers files and folders. 'kRecoverApp' specifies a Restore Task
            that recovers app. 'kCloneApp' specifies a Restore Task that clone
            app. 'kRecoverSanVolume' specifies a Restore Task that recovers
            SAN volumes. 'kConvertAndDeployVMs' specifies a Restore Task that
        ...
        virtual_disk_restore_state (VirtualDiskRecoverState): Specifies the
            complete information about a recover virtual disk task state.
    ...
    def __init__(self,
        ...
        """Constructor for the RestoreTask1 class"""
    ...
    def from_dictionary(cls,
        ...
        clone_view_parameters = cohesity_management_sdk.models.view_1.View1.from_dictionary(dictionary.get('cloneViewParameters')) if dictionary.get('cloneViewParameters') else None
        ...
        mount_volumes_state = cohesity_management_sdk.models.mount_volumes_states.MountVolumesStates.from_dictionary(dictionary.get('mountVolumesState')) if dictionary.get('mountVolumesState') else None
        ...
        virtual_disk_restore_state = cohesity_management_sdk.models.virtual_disk_recover_state.VirtualDiskRecoverState.from_dictionary(dictionary.get('virtualDiskRestoreState')) if dictionary.get('virtualDiskRestoreState') else None
