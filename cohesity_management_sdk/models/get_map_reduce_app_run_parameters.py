...
class GetMapReduceAppRunParameters(object):

    """Implementation of the 'Get Map Reduce App Run Parameters.' model.
    ...
    Attributes:
        ...
        start_offset (int): Start offset for pagination from where result
            needs to be fetched.
    ...
    def __init__(self,
                 ...
                 run_status=None,
                 start_offset=None):
        """Constructor for the GetMapReduceAppRunParameters class"""
