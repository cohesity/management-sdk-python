...
import cohesity_management_sdk.models.hbase_recover_job_params
...
class NoSqlRecoverJobParams(object):
    ...
    Attributes:
        ...
        cassandra_recover_job_params (CassandraRecoverJobParams): Params
            specific to cassandra recover job.
        ...
        hbase_recover_job_params (HBaseRecoverJobParams): Params specific to
            hbase recover job.
        hdfs_recover_job_params (HdfsRecoverJobParams): Params specific to hdfs
            recover job.
