...
import cohesity_management_sdk.models.snapshot_information
import cohesity_management_sdk.models.protection_source
import cohesity_management_sdk.models.backup_run_statistics

class SourceObjectBackupStatus(object):

    """Implementation of the 'Source Object Backup Status.' model.

    Specifies the source object to protect and the current backup status.

    Attributes:
        current_snapshot_info (SnapshotInformation): Specifies details about
            the snapshot task created to backup or copy one source object like
            a VM.
        ...
        stats (BackupRunStatistics): Specifies statistics about a Backup task
            in a Protection Job Run. Specifies statistics for one backup task.
    ...
    def __init__(self,
                 ...
                 status=None,
                 warnings=None):
        """Constructor for the SourceObjectBackupStatus class"""
    ...
    def from_dictionary(cls,
        ...
        current_snapshot_info = cohesity_management_sdk.models.snapshot_information.SnapshotInformation.from_dictionary(dictionary.get('currentSnapshotInfo')) if dictionary.get('currentSnapshotInfo') else None
        ...
        stats = cohesity_management_sdk.models.backup_run_statistics.BackupRunStatistics.from_dictionary(dictionary.get('stats')) if dictionary.get('stats') else None
