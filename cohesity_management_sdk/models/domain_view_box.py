...
import cohesity_management_sdk.models.storage_domain_view_box_stats
import cohesity_management_sdk.models.storage_policy

class DomainViewBox(object):

    """Implementation of the 'Domain (View Box).' model.
    ...
    Attributes:
        ...
        physical_quota (QuotaPolicy): Specifies an optional quota limit (in
            ...
            Nodes.
        removal_state (RemovalState1Enum): Specifies the current removal state
            of the Storage Domain (View Box). 'kDontRemove' means the state of
            object is functional and it is not being removed.
        ...
        stats (StorageDomainViewBoxStats): Provides statistics about the
    ...
    def __init__(self,
        ...
        """Constructor for the DomainViewBox class"""
    ...
    def from_dictionary(cls,
        ...
        stats = cohesity_management_sdk.models.storage_domain_view_box_stats.StorageDomainViewBoxStats.from_dictionary(dictionary.get('stats')) if dictionary.get('stats') else None
