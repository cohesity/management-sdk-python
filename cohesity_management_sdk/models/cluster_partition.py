...
class ClusterPartition(object):
    ...
    Attributes:
        ...
        id (long|int): Specifies a unique identifier for the Cluster Partition.
        ...
        vips (list of string): Array of VIPs.  Specifies a list of Virtual IP
            ...
            Partition.
        vlan_ips (list of string): Array of VLAN IPs.  Specifies a list of VLAN
            IP Addresses that route network traffic within certain VLANs to the
            Cluster Partition.
