...
import cohesity_management_sdk.models.restore_o365_public_folders_params_public_folder
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('folderVec') != None:
            ...
            for structure in dictionary.get('folderVec'):
                folder_vec.append(cohesity_management_sdk.models.restore_o365_public_folders_params_public_folder.RestoreO365PublicFoldersParams_PublicFolder.from_dictionary(structure))
