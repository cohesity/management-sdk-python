...
class Vlan(object):
    ...
    Attributes:
        ...
        add_to_cluster_partition (bool): Specifies whether to add the VLAN IPs
            to the cluster partition that already has one or more IPs from this
            VLAN.
        ...
        dns_delegation_zones (list of DnsDelegationZone): Specifies list of dns
            delegation zones.
        ...
        gateway_v_6_ (string): Specifies the Gateway of the VLAN.
        ...
        ip_family (int): Specifies IP family. Based on this, subnet/gateway
            field contains V4 or V6 values. Used in Request.
        ip_pool_map (object): IpPoolMap.  Pool IPs to program VIP followers.
        ip_range (IpRange): IP Range for vip addition
        ip_ranges (list of IpRange): Array of range of ips. If specified in PUT
            request, Ips field will be ignored. Specifies ips in compressed way
            using list of [start, end] vips.
        ...
        subnet (Subnet): Specifies the subnet of the VLAN. The netmask can be
            ...
            of response.
        subnet_v_6_ (Subnet): Specifies the subnet of the VLAN. The netmask can
    ...
    def __init__(self,
        ...
        self.gateway_v_6_ = gateway_v_6_
    ...
    def from_dictionary(cls,
        ...
        gateway_v_6_ = dictionary.get('gatewayV6')
        ...
        subnet_v_6_ = cohesity_management_sdk.models.subnet.Subnet.from_dictionary(dictionary.get('subnetV6')) if dictionary.get('subnetV6') else None
        tenant_id = dictionary.get('tenantId')
        vlan_name = dictionary.get('vlanName')

        # Return an object of this model
        return cls(
            add_to_cluster_partition,
            all_tenant_access,
            app_ip_vec_in_use,
            appsips,
            description,
