...
class ProtectionSourcesSummaryStatistics(object):

    """Implementation of the 'Protection Sources Summary Statistics.' model.
    ...
    Attributes:
        ...
        registered_source (string): Specifies the name of the Registered
            ...
            Source Object.
        tenants (list of TenantInformation): Specifies basic information about
    ...
    def __init__(self,
                 ...
                 tenants=None):
        """Constructor for the ProtectionSourcesSummaryStatistics class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('tenants') != None:
            ...
            for structure in dictionary.get('tenants'):
                tenants.append(cohesity_management_sdk.models.tenant_information.TenantInformation.from_dictionary(structure))
