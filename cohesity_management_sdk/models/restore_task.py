...
class RestoreTask(object):
    ...
    """Implementation of the 'Restore Task.' model.
    ...
    Attributes:
        ...
        source_object_info (RestoreObject): Specifies information about the
            source object (such as a VM) that contains the files and folders
            to recover. In addition, it contains information about the
