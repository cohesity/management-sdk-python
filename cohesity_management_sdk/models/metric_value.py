...
class MetricValue(object):
    ...
    Attributes:
        ...
        timestamp_msecs (long|int): Specifies the creation time of a data point
            as a Unix epoch Timestamp (in milliseconds).
        value (Value): Specifies the value of the data point.
    """
