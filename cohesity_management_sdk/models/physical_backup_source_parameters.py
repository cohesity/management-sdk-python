...
import cohesity_management_sdk.models.physical_file_backup_parameters
import cohesity_management_sdk.models.physical_snapshot_params
import cohesity_management_sdk.models.source_app_params

class PhysicalBackupSourceParameters(object):

    """Implementation of the 'Physical Backup Source Parameters.' model.
    ...
    Attributes:
        ...
        file_backup_params (PhysicalFileBackupParameters): Message to capture
    ...
    def __init__(self,
        ...
        """Constructor for the PhysicalBackupSourceParameters class"""
    ...
    def from_dictionary(cls,
        ...
        file_backup_params = cohesity_management_sdk.models.physical_file_backup_parameters.PhysicalFileBackupParameters.from_dictionary(dictionary.get('fileBackupParams')) if dictionary.get('fileBackupParams') else None
