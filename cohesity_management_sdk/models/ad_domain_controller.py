...
class AdDomainController(object):
    ...
    Attributes:
        ...
        domain (AdDomain): Specifies Domain hosted on this domain controller.
        host_name (string): Specifies FQDN host name of the domain controller.
        is_global_catalog (bool): Specifies whether this domain controller is a
