...
class UserIdMapping(object):
    ...
    Attributes:
        ...
        centrify_zone_mapping (CentrifyZone): Specifies a centrify zone when
            mapping type is set to 'kCentrify'. It defines a centrify zone from
            which the user id mapping info would be derived.
        ...
        fixed_mapping (FixedUnixIdMapping): Specifies the fields when mapping
            type is set to 'kFixed'. It maps all Active Directory users of this
            domain to a fixed uid, and gid.
        mtype (TypeUserIdMappingEnum): Specifies the mapping type used. 'kRid'
            ...
            'kFixed' indicates the mapping from all Active Directory users to a
            fixed Unix uid, and gid. 'kCustomAttributes' indicates the mapping
            to derive from custom attributes defined in an AD domain.
