...
class ProtectedObjectPrivileges(object):
    ...
    Attributes:
        ...
        protected_objectsprivileges_type (ProtectedObjectsPrivilegesTypeEnum):
            Specifies if all, none or specific protected objects are allowed to
            be accessed. Specifies if all, none or specific protected objects
            are allowed to be accessed. kNone - None of the protected objects
            have access. kAll - All the protected objects have access.
    ...
    def from_dictionary(cls,
        ...
        return cls(
            protected_objectsprivileges_type,
