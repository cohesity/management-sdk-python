...
class ClusterStatusResult(object):
    ...
    Attributes:
        ...
        stopped_services (list of StoppedServiceEnum): Specifies the list of
            ...
            distributed file system. 'kGenie' is a service that is
            ...
            Clusters and configuration of Nodes and networking. 
            'kNexusProxy' is a service that links the Nexus service to other
            ...
            can be backed up to. 'kSmbProxy' is an SMB protocol service.
