...
class VmwareBackupSourceParameters(object):

    """Implementation of the 'VMware Backup Source Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VmwareBackupSourceParameters class"""
