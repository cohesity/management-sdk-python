...
class CreateAccessTokenCredentialRequest(object):

    """Implementation of the 'Create Access Token Credential Request.' model.
    ...
    def __init__(self,
                 ...
                 username=None,
                 domain=None):
        """Constructor for the CreateAccessTokenCredentialRequest class"""
