...
class AcropolisBackupSourceParams(object):
    ...
    Message to capture additional backup params for a Acropolis type
    source.
    ...
    Attributes:
        ...
        acropolis_disk_inclusion_info (list of AcropolisDiskFilterProto): List
            ...
            the source. These disks will be only included for the source and all
            other disks will be excluded. Overrides the disk exclusion/inclusion
            list from EnvBackupParams.AcropolisBackupEnvParams.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('acropolisDiskExclusionInfo', None):
            ...
            for structure in dictionary.get('acropolisDiskExclusionInfo', None):
        ...
        return cls(acropolis_disk_exclusion_info,
