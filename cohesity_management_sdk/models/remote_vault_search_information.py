...
class RemoteVaultSearchInformation(object):

    """Implementation of the 'Remote Vault Search Information.' model.
    ...
    Attributes:
        ...
        search_job_uid (UniqueGlobalId): Specifies the unique id assigned to
            the search Job by the Cluster.
    ...
    def __init__(self,
                 ...
                 vault_id=None,
                 vault_name=None):
        """Constructor for the RemoteVaultSearchInformation class"""
