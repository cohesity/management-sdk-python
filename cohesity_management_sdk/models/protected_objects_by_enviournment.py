...
class ProtectedObjectsByEnviournment(object):

    """Implementation of the 'Protected Objects By Enviournment.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ProtectedObjectsByEnviournment class"""
