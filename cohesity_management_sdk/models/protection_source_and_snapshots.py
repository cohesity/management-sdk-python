...
class ProtectionSourceAndSnapshots(object):

    """Implementation of the 'Protection Source and Snapshots.' model.
    ...
    def __init__(self,
                 ...
                 snapshots_info=None):
        """Constructor for the ProtectionSourceAndSnapshots class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('snapshotsInfo') != None:
            ...
            for structure in dictionary.get('snapshotsInfo'):
                snapshots_info.append(cohesity_management_sdk.models.protection_source_snapshot.ProtectionSourceSnapshot.from_dictionary(structure))
