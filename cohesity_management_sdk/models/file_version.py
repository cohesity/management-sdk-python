...
class FileVersion(object):
    ...
    Attributes:
        ...
        snapshots (list of SnapshotAttempt): Array of Snapshots.  Specifies the
            available snapshots of the file or folder. When a Job Run executes,
            it captures a snapshot of object (such as a VM) that contains the
            file or folder.
    """
