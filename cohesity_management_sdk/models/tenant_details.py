...
import cohesity_management_sdk.models.active_directory
...
class TenantDetails(object):
    ...
    """Implementation of the 'Tenant Details.' model.

    Specifies details about a tenant.

    Attributes:
        active_directories (list of ActiveDirectory): Specifies the active
    ...
    def __init__(self,
        ...
        """Constructor for the TenantDetails class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('activeDirectories') != None:
            ...
            for structure in dictionary.get('activeDirectories'):
                active_directories.append(cohesity_management_sdk.models.active_directory.ActiveDirectory.from_dictionary(structure))
