...
class QuotaPolicy(object):
    ...
    Attributes:
        ...
        alert_limit_bytes (long|int): Specifies if an alert should be triggered
            when the usage of this resource exceeds this quota limit. This
            limit is optional and is specified in bytes. If no value is
        ...
        alert_threshold_percentage (long|int): Supported only for user quota
            ...
            percentage which is: HardLimitBytes * AlertThresholdPercentage, eg:
            80% of HardLimitBytes Can only be set if HardLimitBytes is set.
