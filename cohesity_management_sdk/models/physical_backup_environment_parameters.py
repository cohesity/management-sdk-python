...
class PhysicalBackupEnvironmentParameters(object):

    """Implementation of the 'Physical Backup Environment Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PhysicalBackupEnvironmentParameters class"""
