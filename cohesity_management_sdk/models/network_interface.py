...
class NetworkInterface(object):
    ...
    Attributes:
        ...
        gateway_6_ (string): Specifies the gateway6 of the interface.
        ...
        static_ip_6_ (string): Specifies the static IPv6 of the interface.
        stats (InterfaceStats): Interface Stats.
        subnet (string): Specifies the subnet mask of the interface.
        subnet_6_ (string): Specifies the subnet6 mask of the interface.
    ...
    def __init__(self,
        ...
        self.static_ip_6_ = static_ip_6_
        self.stats = stats
        self.subnet = subnet
        self.subnet_6_ = subnet_6_
        self.mtype = mtype
    ...
    def from_dictionary(cls,
        ...
        gateway_6_ = dictionary.get('gateway6')
        ...
        static_ip_6_ = dictionary.get('staticIp6')
        ...
        subnet_6_ = dictionary.get('subnet6')
