...
class VolumeInfo_SubVolumeInfo(object):
    ...
    The proto is used only for storing BTRFS subvolume fields. This is required
    for handling of mountable subvolume.


    Attributes:

        subvolume_name (string): Name of subvolume. Used to provide relevant
            mount options.
    """
