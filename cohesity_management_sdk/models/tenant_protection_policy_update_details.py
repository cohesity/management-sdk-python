...
class TenantProtectionPolicyUpdateDetails(object):

    """Implementation of the 'Tenant Protection Policy Update Details.' model.
    ...
    def __init__(self,
                 policy_ids=None,
                 tenant_id=None):
        """Constructor for the TenantProtectionPolicyUpdateDetails class"""
