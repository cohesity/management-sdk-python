...
class RestoreObject(object):
    ...
    """Implementation of the 'Restore Object.' model.
    ...
    Attributes:
        ...
        environment (Environment5Enum): Specifies the type of the Protection
            Source. Supported environment types such as 'kView', 'kSQL',
