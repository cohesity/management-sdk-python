...
class ProtectionSourcesSummaryStats(object):
    ...
    Specifies Job Run (Snapshot) summary statistics about the specified leaf
    Protection Source Object (such as a VM).


    Attributes:

        first_failed_run_time_usecs (long|int): Specifies the start time of the
            first failed Job Run protecting this Protection Source Object. The
            time is specified as a Unix epoch Timestamp (in microseconds).
        first_successful_run_time_usecs (long|int): Specifies the start time of
            the first successful Job Run protecting this Protection Source
        ...
        last_run_status (LastRunStatusEnum): Specifies the Job Run status of
            ...
            'kCancelled' indicates that the Job Run was canceled. 'kError'
            indicates the Job Run encountered an error and did not run to
            completion.
        last_run_type (LastRunTypeEnum): Specifies the Job Run type of the last
            Job Run protecting this Protection Source Object. 'kRegular'
            ...
            blocks. 'kFull' indicates a full (no CBT) backup. A complete backup
            ...
            rolling back to a specific point in time. 'kSystem' indicates
            system volume backup. It produces an image for bare metal recovery.
        ...
        num_logical_bytes_protected (long|int): Specifies the total logical
            bytes protected for this Protection Source Object. The logical size
            is when the data is fully hydrated or expanded.
        ...
        registered_source (string): Specifies the name of the Registered Source
            that is the top level parent of the specified Protection Source
            Object.
        tenants (list of TenantInfo): Specifies basic information about tenants
            having access to the protection job.
    """
