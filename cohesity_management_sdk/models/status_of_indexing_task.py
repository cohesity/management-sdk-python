...
class StatusOfIndexingTask(object):

    """Implementation of the 'Status of Indexing Task.' model.
    ...
    Attributes:
        ...
        indexing_task_status (IndexingTaskStatusEnum): Specifies the status of
            ...
            paused.
        indexing_task_uid (UniqueGlobalId): Specifies the unique id of the
    ...
    def __init__(self,
        ...
        """Constructor for the StatusOfIndexingTask class"""
    ...
    def from_dictionary(cls,
        ...
        indexing_task_uid = cohesity_management_sdk.models.unique_global_id.UniqueGlobalId.from_dictionary(dictionary.get('indexingTaskUid')) if dictionary.get('indexingTaskUid') else None
