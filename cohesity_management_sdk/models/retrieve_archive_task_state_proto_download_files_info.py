...
class RetrieveArchiveTaskStateProto_DownloadFilesInfo(object):
    ...
    from archive stub views are ready, we will just discard this proto and make
    field 20 reserved.


    Attributes:

        file_path_vec (list of string): The file paths to be retrieved from the
            archive. For example, if the file paths are /foo/bar and /foo2/bar
            and target_dir_path is "downloaded_files". The retrieved files will
            have the full path structure maintained in target_dir_path such as
        ...
        object_id (MagnetoObjectId): Object from which the requested files will
            be restored.
    ...
    def __init__(self,
        ...
        """Constructor for the RetrieveArchiveTaskStateProto_DownloadFilesInfo class"""
