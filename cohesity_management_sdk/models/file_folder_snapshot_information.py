...
class FileFolderSnapshotInformation(object):

    """Implementation of the 'File/Folder Snapshot Information.' model.
    ...
    def __init__(self,
                 ...
                 size_bytes=None,
                 snapshot=None):
        """Constructor for the FileFolderSnapshotInformation class"""
