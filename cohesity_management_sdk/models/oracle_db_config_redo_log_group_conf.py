...
class OracleDBConfig_RedoLogGroupConf(object):

    """Implementation of the 'OracleDBConfig_RedoLogGroupConf' model.

    GROUP1 : {DST1/CH1.log, DST2/CH1.log} GROUP2 : {DST1/CH2.log, DST2/CH2.log}
    ...
    def __init__(self,
        ...
        """Constructor for the OracleDBConfig_RedoLogGroupConf class"""
