...
class UpdateLDAPProviderParameters(object):

    """Implementation of the 'Update LDAP Provider Parameters.' model.
    ...
    def __init__(self,
                 ...
                 user_password=None):
        """Constructor for the UpdateLDAPProviderParameters class"""
