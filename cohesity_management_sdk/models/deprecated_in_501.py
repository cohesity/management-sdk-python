...
import cohesity_management_sdk.models.only_one_of_the_following_fields_should_be_set

class DEPRECATEDIn501(object):

    """Implementation of the 'DEPRECATED in 5.0!1' model.
    ...
    Attributes:
        ...
        retry_delay_mins (int): The number of minutes to wait before retrying
            a failed job.
        schedule_end (OnlyOneOfTheFollowingFieldsShouldBeSet): TODO: type
            description here.
    ...
    def __init__(self,
                 ...
                 truncate_logs=None):
        """Constructor for the DEPRECATEDIn501 class"""
    ...
    def from_dictionary(cls,
        ...
        schedule_end = cohesity_management_sdk.models.only_one_of_the_following_fields_should_be_set.OnlyOneOfTheFollowingFieldsShouldBeSet.from_dictionary(dictionary.get('scheduleEnd')) if dictionary.get('scheduleEnd') else None
