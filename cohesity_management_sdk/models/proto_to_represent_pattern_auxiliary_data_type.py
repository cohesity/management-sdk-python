...
class ProtoToRepresentPatternAuxiliaryDataType(object):

    """Implementation of the 'Proto to represent pattern auxiliary data type.' model.
    ...
    def __init__(self,
                 ...
                 mtype=None,
                 value=None):
        """Constructor for the ProtoToRepresentPatternAuxiliaryDataType class"""
