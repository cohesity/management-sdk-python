...
class UpdateBlacklistedTrustedDomainRequest(object):

    """Implementation of the 'Update Blacklisted Trusted Domain Request.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateBlacklistedTrustedDomainRequest class"""
