...
class DataMigrationPolicy(object):
    ...
    Attributes:
        ...
        scheduling_policy (SchedulingPolicy): Specifies schedule for the data
            migration job.
        worm_retention_type (WormRetentionTypeEnum): Specifies WORM retention
            type for the files. When a WORM retention type is specified, the
            files will be kept until the maximum of the retention time. During
            that time, the files cannot be deleted. 'kNone' implies there is no
