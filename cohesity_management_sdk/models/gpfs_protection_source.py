...
class GpfsProtectionSource(object):
    ...
    Attributes:
        ...
        cluster (GpfsCluster): Specifies information of an GPFS Cluster. This
            is set only when the entity type is 'kCluster'.
        fileset (GpfsFileset): Specifies information about a mount point in an
            GPFS file system. This is set only when the entity type is
            'kFileset'.
        filesystem (GpfsFilesystem): Specifies an access zone in an GPFS file
            system. This is set only when the entity type is 'kFilesystem'.
