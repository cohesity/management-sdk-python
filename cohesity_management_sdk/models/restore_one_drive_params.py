...
class RestoreOneDriveParams(object):
    ...
    Attributes:
        ...
        drive_owner_vec (list of RestoreOneDriveParams_DriveOwner): The list of
            users/groups whose drives are being restored.
        restore_to_original (bool): Whether or not all drive items are restored
            to original location.
        target_drive_id (string): The id of the drive in which items will be
            restored.
        target_folder_path (string): All drives part of various users listed in
            drive_owner_vec will be restored to the drive belonging to
            target_user having id target_drive_id. Let's say drive_owner_vec is
            A and B; drive_vec of A and B is 111 and 222 respectively;
        ...
        target_user (EntityProto): This is the user in whose drive the items
            will be restored.
    """
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('driveOwnerVec') != None:
            ...
            for structure in dictionary.get('driveOwnerVec'):
                drive_owner_vec.append(cohesity_management_sdk.models.restore_one_drive_params_drive_owner.RestoreOneDriveParams_DriveOwner.from_dictionary(structure))
