...
class RestorePointsForTimeRangeParameters(object):

    """Implementation of the 'Restore Points for Time Range Parameters.' model.
    ...
    Attributes:
        ...
        environment (Environment15Enum): Specifies the protection source
            environment type. Supported environment types such as 'kView',
            ...
            Source environment.
        job_uids (list of UniqueGlobalId): Specifies the jobs for which to get
    ...
    def __init__(self,
        ...
        """Constructor for the RestorePointsForTimeRangeParameters class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('jobUids') != None:
            ...
            for structure in dictionary.get('jobUids'):
                job_uids.append(cohesity_management_sdk.models.unique_global_id.UniqueGlobalId.from_dictionary(structure))
