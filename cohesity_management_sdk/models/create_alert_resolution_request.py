...
class CreateAlertResolutionRequest(object):

    """Implementation of the 'Create Alert Resolution Request.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CreateAlertResolutionRequest class"""
