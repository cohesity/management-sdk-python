...
class AddGroupsOrUsersRequest(object):

    """Implementation of the 'Add Groups or Users Request.' model.
    ...
    Attributes:
        ...
        object_class (ObjectClass1Enum): Specifies the type of the referenced
    ...
    def __init__(self,
                 ...
                 restricted=None,
                 roles=None):
        """Constructor for the AddGroupsOrUsersRequest class"""
