...
class EntitySchemaProto_Granularity(object):
    ...
    Rolling up or Down sampling is performed on timeseries data to reduce space
    usage by timeseries. Rollup Granularity is defined per entity schema but
    rollup function is not defined. Instead we create rolledup values for all
    the rollup functions.
    ...
    Attributes:
        ...
        rollup_interval_secs (int): Defines the rollup interval or a bucket
            ...
            say, raw metric is published at ~30 secs granularity. To generate a
            hourly or a daily summary time series, client can define rolled up
            metrics having interval 3600 secs and 86400 secs respectively.
        time_to_live_secs (long|int): Defines the duration for which the rolled
            up data is to be stored. Once the lifespan has elapsed, expired
    ...
    def from_dictionary(cls,
        ...
        rollup_interval_secs = dictionary.get('rollupIntervalSecs')
