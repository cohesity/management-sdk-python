...
class ProtectionSummaryByEnvironment(object):

    """Implementation of the 'Protection Summary By Environment.' model.

    ProtectionSummaryByEnv specifies the number of protected and unprotected
    objects that is break down by environment.

    Attributes:
        environment (Environment8Enum): Specifies the type of environment of
            the source object like kSQL etc. Supported environment types such
    ...
    def __init__(self,
        ...
        """Constructor for the ProtectionSummaryByEnvironment class"""
