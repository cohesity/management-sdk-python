...
class SnapshotCopyReplicationPolicy(object):

    """Implementation of the 'Snapshot Copy Replication Policy.' model.
    ...
    Attributes:
        ...
        periodicity (PeriodicityEnum): Specifies the frequency that Snapshots
            ...
            multiplier.
        target (ReplicationTarget1): Specifies the replication target to copy
            the Snapshots to.
    ...
    def __init__(self,
                 ...
                 periodicity=None,
                 target=None):
        """Constructor for the SnapshotCopyReplicationPolicy class"""
    ...
    def from_dictionary(cls,
        ...
        target = cohesity_management_sdk.models.replication_target_1.ReplicationTarget1.from_dictionary(dictionary.get('target')) if dictionary.get('target') else None
