...
class EnvironmentsEnum(object):

    """Implementation of the 'Environments' enum.
    Specifies a list of applications environment that are registered with this
    Protection Source such as 'kSQL'. Supported environment types such as
