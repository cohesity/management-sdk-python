...
class MountVolumesStates(object):

    """Implementation of the 'Mount Volumes States.' model.
    ...
    Attributes:
        ...
        mount_volume_results (list of MountVolumeResultDetails): Array of
            ...
            specified volume.
        other_error (Error): Specifies an error that did not occur during the
            mount operation.
    ...
    def __init__(self,
                 ...
                 username=None):
        """Constructor for the MountVolumesStates class"""
    ...
    def from_dictionary(cls,
        ...
        other_error = cohesity_management_sdk.models.error.Error.from_dictionary(dictionary.get('otherError')) if dictionary.get('otherError') else None
