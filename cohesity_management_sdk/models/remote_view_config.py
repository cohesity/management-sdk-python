...
class RemoteViewConfig(object):
    ...
    Attributes:
        ...
        source_view_id (long|int): Specifies the view Id of the view protected
            by the view protection job.
        use_same_view_name (bool): Specifies if the remote view name is same as
            the source view name. If this field is true, viewName is ignored as
            the remote view name is same as the source view name.
