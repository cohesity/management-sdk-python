...
class ClusterConfigProto_SID(object):
    ...
    Attributes:
        ...
        identifier_authority (list of long|int): The authority under which the
            SID was created. This is always 6 bytes long.
    ...
    def __init__(self,
        ...
        """Constructor for the ClusterConfigProto_SID class"""
