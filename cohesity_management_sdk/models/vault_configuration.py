...
import cohesity_management_sdk.models.nas_server_credentials
...
class VaultConfiguration(object):
    ...
    """Implementation of the 'Vault Configuration.' model.
    ...
    def __init__(self,
                 ...
                 oracle=None,
                 qstar=None):
        """Constructor for the VaultConfiguration class"""
    ...
    def from_dictionary(cls,
        ...
        nas = cohesity_management_sdk.models.nas_server_credentials.NASServerCredentials.from_dictionary(dictionary.get('nas')) if dictionary.get('nas') else None
