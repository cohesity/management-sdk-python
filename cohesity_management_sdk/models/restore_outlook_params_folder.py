...
class RestoreOutlookParams_Folder(object):
    ...
    Attributes:
        ...
        is_entire_folder_required (bool): Specify if the entire folder is to be
            restored.
    ...
    def __init__(self,
        ...
        """Constructor for the RestoreOutlookParams_Folder class"""
