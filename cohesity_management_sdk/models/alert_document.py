...
class AlertDocument(object):
    ...
    Attributes:
        ...
        alert_description (string): Specifies brief description about the Alert
            that is used in the subject line when sending a notification email
            for an Alert.
        ...
        alert_name (string): Specifies short name that describes the Alert type
            such as DiskBad, HighCpuUsage, FrequentProcessRestarts, etc.
    """
