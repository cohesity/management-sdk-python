...
class NetAppVserverInformation(object):

    """Implementation of the 'NetApp Vserver Information.' model.
    ...
    Attributes:
        ...
        mtype (Type13Enum): Specifies the type of this Vserver. Specifies the
            type of the NetApp Vserver. 'kData' indicates the Vserver is used
            for data backup and restore. 'kAdmin' indicates the Vserver is
            used for cluster-wide management. 'kSystem' indicates the Vserver
            is used for cluster-scoped communications in an IPspace. 'kNode'
            indicates the Vserver is used as the physical controller.
    ...
    def __init__(self,
                 ...
                 mtype=None):
        """Constructor for the NetAppVserverInformation class"""
    ...
    def from_dictionary(cls,
        ...
        root_cifs_share = cohesity_management_sdk.models.cifs_share_information.CIFSShareInformation.from_dictionary(dictionary.get('rootCifsShare')) if dictionary.get('rootCifsShare') else None
