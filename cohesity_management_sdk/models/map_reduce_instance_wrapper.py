...
class MapReduceInstanceWrapper(object):
    ...
    """Implementation of the 'Map Reduce Instance Wrapper.' model.
    ...
    Attributes:
        log_path (string): LogPath is the path of the log files for the MR
            instance run.
        mr_instance (MapReduceInstance): Information about a Map reduce
            instance. An instance can be run only once.
