...
import cohesity_management_sdk.models.attributes_descriptor
import cohesity_management_sdk.models.time_series

class EntitySchema(object):

    """Implementation of the 'Entity Schema.' model.

    Specifies the meta-data associated with entity such as the list of
    attributes and time series data.

    Attributes:
        attributes_descriptor (AttributesDescriptor): Specifies a list of
        ...
        time_series_descriptor_vec (list of TimeSeries): Array of Time Series.
    ...
    def __init__(self,
                 ...
                 version=None):
        """Constructor for the EntitySchema class"""
    ...
    def from_dictionary(cls,
        ...
        attributes_descriptor = cohesity_management_sdk.models.attributes_descriptor.AttributesDescriptor.from_dictionary(dictionary.get('attributesDescriptor')) if dictionary.get('attributesDescriptor') else None
        ...
        if dictionary.get('timeSeriesDescriptorVec') != None:
            ...
            for structure in dictionary.get('timeSeriesDescriptorVec'):
                time_series_descriptor_vec.append(cohesity_management_sdk.models.time_series.TimeSeries.from_dictionary(structure))
