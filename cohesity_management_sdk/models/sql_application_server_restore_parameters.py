...
class SQLApplicationServerRestoreParameters(object):

    """Implementation of the 'SQL Application Server Restore Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the SQLApplicationServerRestoreParameters class"""
