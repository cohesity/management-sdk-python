...
class TagsOperationParameters(object):
    ...
    Attributes:
        ...
        cluster_id (long|int): ClusterId is the Id of the cluster used for
            constructing JobUid.
        cluster_incarnation_id (long|int): ClusterIncarnationId is the
        ...
        document_ids (list of string): DocumentIds are list of documents to be
            tagged.
        entity_id (long|int): EntityId is the Id of the entity where the file
            resides.
        job_id (long|int): JobId is the Id of the job that took the snapshot.
        job_instance_ids (list of long|int): JobInstanceIds to tag
        ...
        tags (list of string): Tags are list of tags that will be operated on
            to corresponding objects. This is deprecated. Use tagIds instead.
            deprecated: true
    """
