...
import cohesity_management_sdk.models.application_information
...
class RegistrationAndProtectionInformation(object):

    """Implementation of the 'Registration and Protection Information.' model.
    ...
    Attributes:
        applications (list of ApplicationInformation): Array of applications
        ...
        stats_by_env (list of ProtectionSummaryByEnvironment): Specifies the
            breakdown of the stats of protection by environment.
    ...
    def __init__(self,
                 ...
                 stats=None,
                 stats_by_env=None):
        """Constructor for the RegistrationAndProtectionInformation class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('applications') != None:
            ...
            for structure in dictionary.get('applications'):
                applications.append(cohesity_management_sdk.models.application_information.ApplicationInformation.from_dictionary(structure))
