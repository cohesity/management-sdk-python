...
class ImportConfigurations(object):
    ...
    """Implementation of the 'Import Configurations.' model.
    ...
    Attributes:
        ...
        partitions (list of long|int): Selective import of Partiton.
        ...
        view_boxes (list of long|int): Selective import certain Storage
            Domains (View Boxes).
