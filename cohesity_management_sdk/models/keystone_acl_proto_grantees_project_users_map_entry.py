...
class KeystoneACLProto_Grantees_ProjectUsersMapEntry(object):
    ...
    def from_dictionary(cls,
        ...
        value = cohesity_management_sdk.models.keystone_acl_proto_grantees_project_users.KeystoneACLProto_Grantees_ProjectUsers.from_dictionary(dictionary.get('value')) if dictionary.get('value') else None
