...
class EnvironmentProtectionJobRequestBodyEnum(object):
    ...
    """Implementation of the 'EnvironmentProtectionJobRequestBody' enum.
    Specifies the environment type (such as kVMware or kSQL) of the Protection
    Source this Job is protecting. Supported environment types such as 'kView',
