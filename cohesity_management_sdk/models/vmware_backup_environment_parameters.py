...
class VmwareBackupEnvironmentParameters(object):

    """Implementation of the 'VMware Backup Environment Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VmwareBackupEnvironmentParameters class"""
