...
class EnvironmentRegisterProtectionSourceParametersEnum(object):
    ...
    """Implementation of the 'EnvironmentRegisterProtectionSourceParameters' enum.
    Specifies the environment such as 'kPhysical' or 'kVMware' of the
    Protection Source. overrideDescription: true Supported environment types
    such as 'kView', 'kSQL', 'kVMware', etc. NOTE: 'kPuppeteer' refers to
    Cohesity's Remote Adapter. 'kVMware' indicates the VMware Protection Source
