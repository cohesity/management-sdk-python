...
class TypeAzureProtectionSourceEnum(object):
    ...
    """Implementation of the 'TypeAzureProtectionSource' enum.
    ...
    container. 'kStorageResourceGroup' indicates a container that holds related
    storage resources. 'kNetworkSecurityGroup' represents a network security
    group. 'kVirtualNetwork' represents a virtual network.
    ...
    available for a type of a Virtual Machine. 'kAvailabilitySet' indicates the
    availability set.
