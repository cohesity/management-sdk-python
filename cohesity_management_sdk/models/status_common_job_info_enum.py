...
class StatusCommonJobInfoEnum(object):

    """Implementation of the 'StatusCommonJobInfo' enum.
    Specifies the status of the job. 'kJobRunning' indicates that the Job/task
    is currently running. 'kJobFinished' indicates that the Job/task completed
    and finished. 'kJobFailed' indicates that the Job/task failed and did not
