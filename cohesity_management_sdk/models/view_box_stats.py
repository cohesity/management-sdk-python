...
class ViewBoxStats(object):
    ...
    Attributes:
        ...
        cloud_usage_perf_stats (UsageAndPerformanceStats): Provides the usage
            statistics for the data stored in the cloud for the Storage Domain
            (View Box). Performance statistics are not populated.
        ...
        logical_stats (LogicalStats): Provides the logical usage statistics for
            the Storage Domain (View Box).
        usage_perf_stats (UsageAndPerformanceStats): Provides usage and
            performance statistics for the Storage Domain (View Box) (includes
