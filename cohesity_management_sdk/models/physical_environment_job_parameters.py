...
class PhysicalEnvironmentJobParameters(object):

    """Implementation of the 'Physical Environment Job Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PhysicalEnvironmentJobParameters class"""
