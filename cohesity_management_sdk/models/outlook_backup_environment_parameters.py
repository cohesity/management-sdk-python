...
class OutlookBackupEnvironmentParameters(object):

    """Implementation of the 'Outlook Backup Environment Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the OutlookBackupEnvironmentParameters class"""
