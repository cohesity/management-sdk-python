...
class TaskEvent(object):
    ...
    Attributes:
        ...
        event_message (string): Specifies the message associated with an event.
        percent_finished (float): Specifies the completion percentage of the
            task attached to this event.
        remaining_work_count (long|int): Specifies the amount of work remaining
            for the task attached to this event.
