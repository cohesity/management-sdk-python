...
class FlashBladeFileSystem(object):
    ...
    Attributes:
        ...
        backup_enabled (bool): Specifies whether the .snapshot directory exists
            on the file system. Backup is enabled only if the directory exists.
        ...
        nfs_info (FlashBladeNfsInfo): Specifies information about an NFS
            export. This field is set if the file system supports protocol type
            'kNfs'.
        physical_used_bytes (long|int): Specifies the size of physical data
            currently consumed by the file system. This includes the space used
            for the snapshots.
        protocols (list of ProtocolsEnum): List of Protocols.  Specifies the
