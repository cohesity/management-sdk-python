...
class UpdateIDMappingInformationRequest(object):

    """Implementation of the 'Update ID Mapping Information Request.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateIDMappingInformationRequest class"""
