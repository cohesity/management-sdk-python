...
class DataTransferToVaultSummary(object):
    ...
    """Implementation of the 'Data Transfer to Vault Summary.' model.
    ...
    Attributes:
        ...
        logical_data_transferred_bytes_during_time_range (list of long|int):
            ...
            the time period specified using the startTimeMsecs and
            ...
            elements are returned. The logical size is when the data is fully
        ...
        num_logical_bytes_transferred (long|int): Specifies the total number
            ...
            to this Vault. The logical size is when the data is fully hydrated
            or expanded.
        ...
        physical_data_transferred_bytes_during_time_range (list of long|int):
            ...
            physical data transferred from this Cohesity Cluster to this Vault
        ...
        vault_name (string): Specifies the name of the Vault (External
            Target).
        vault_type (VaultType1Enum): Specifies the type of Vault. 'kNearline'
            indicates a Google Nearline Vault. 'kColdline' indicates a Google
            Coldline Vault. 'kGlacier' indicates a AWS Glacier Vault. 'kS3'
            indicates a AWS S3 Vault. 'kAzureStandard' indicates a Microsoft
            Azure Standard Vault. 'kS3Compatible' indicates a AWS S3
            Compatible Vault. (See the online help for supported types.)
            'kQStarTape' indicates a QStar Tape Vault. 'kGoogleStandard'
            indicates a Google Standard Vault. 'kGoogleDRA' indicates a Google
            DRA Vault. 'kAWSGovCloud' indicates a AWS Gov Cloud Vault. 'kNAS'
            indicates a NAS Vault. 'kAzureGovCloud' indicates an Microsoft
            Azure Gov Cloud Vault.
