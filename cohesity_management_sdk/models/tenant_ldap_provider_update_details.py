...
class TenantLdapProviderUpdateDetails(object):

    """Implementation of the 'Tenant Ldap Provider Update Details.' model.
    ...
    def __init__(self,
                 ...
                 tenant_id=None):
        """Constructor for the TenantLdapProviderUpdateDetails class"""
