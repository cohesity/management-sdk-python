...
class RestoreProtectionJobIndexAndSnapshots(object):

    """Implementation of the 'Restore Protection Job Index and Snapshots.' model.

    Specifies settings required to restore the index and Snapshots of
    a Protection Job.

    Attributes:
        archive_task_uid (UniqueGlobalId): Specifies a unique id of the
            Archive task that originally archived the object to the Vault.
        end_time_usecs (long|int): Specifies the end time as a Unix epoch
            ...
            restored.
        remote_protection_job_uid (UniqueGlobalId): Specifies a unique id
    ...
    def __init__(self,
                 ...
                 view_box_id=None):
        """Constructor for the RestoreProtectionJobIndexAndSnapshots class"""
    ...
    def from_dictionary(cls,
        ...
        remote_protection_job_uid = cohesity_management_sdk.models.unique_global_id.UniqueGlobalId.from_dictionary(dictionary.get('remoteProtectionJobUid')) if dictionary.get('remoteProtectionJobUid') else None
