...
class WindowsHostSnapshotParameters(object):
    ...
    Attributes:
        ...
        disable_metadata (bool): Specifies whether to disable fetching and
            storing of some metadata on Cohesity Cluster to save storage space.
            Otherwise, there will be some metadata fetched and stored on
            Cohesity Cluster.
        ...
        excluded_vss_writers (list of string): Specifies a list of Windows VSS
            ...
            "System Writer". Refer Microsoft documentaion for a complete list.
    """
