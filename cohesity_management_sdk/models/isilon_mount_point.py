...
class IsilonMountPoint(object):
    ...
    Attributes:
        ...
        nfs_mount_point (IsilonNfsMountPoint): Specifies information about an
            NFS export. This field is set if the file system supports protocol
            type 'kNfs'.
        path (string): Specifies the path of the access zone in ifs. This
            should include the leading "/ifs/".
        protocols (list of ProtocolsEnum): List of Protocols on Isilon. 
