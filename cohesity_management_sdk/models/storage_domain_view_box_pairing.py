...
class StorageDomainViewBoxPairing(object):

    """Implementation of the 'Storage Domain (View Box) Pairing.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the StorageDomainViewBoxPairing class"""
