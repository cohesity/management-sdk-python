...
import cohesity_management_sdk.models.restore_o365_teams_params_source_channel
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('sourceChannelVec') != None:
            ...
            for structure in dictionary.get('sourceChannelVec'):
                source_channel_vec.append(cohesity_management_sdk.models.restore_o365_teams_params_source_channel.RestoreO365TeamsParams_SourceChannel.from_dictionary(structure))
