...
class CompareADObjectsResult_ADAttributeValue(object):
    ...
    Attributes:
        ...
        value_vec (list of string): String representation of attribute value.
            ...
            will contain values that are in same order as contained in AD. Each
            AD attribute value will be converted to string. If this property is
            not set, then the property has null value.
    """
    ...
    def __init__(self,
        ...
        """Constructor for the CompareADObjectsResult_ADAttributeValue class"""
