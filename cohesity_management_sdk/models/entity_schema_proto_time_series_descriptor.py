...
class EntitySchemaProto_TimeSeriesDescriptor(object):
    ...
    Attributes:
        ...
        metric_unit (EntitySchemaProto_TimeSeriesDescriptor_MetricUnit): TODO:
            Type description here.
        raw_metric_publish_interval_hint_secs (int): Specifies a suggestion for
            the interval to collect raw data points.
        time_to_live_secs (long|int): Specifies how long the data point will be
            ...
            time_to_live_secs per schema(defined below) For existing schemas,
            we will consider highest time_to_live_secs of all metrics as
            expiration time for all metrics defined in schema.
        value_type (int): Specifies the value type for this metric. A metric of
            type 'string" is not supported, instead use 'bytes'. Note that an
            aggregate metric of type 'bytes' is not supported. 0 specifies a
            value type of Int64. 1 specifies a value type of Double. 2
    ...
    def from_dictionary(cls,
        ...
        metric_unit = cohesity_management_sdk.models.entity_schema_proto_time_series_descriptor_metric_unit.EntitySchemaProto_TimeSeriesDescriptor_MetricUnit.from_dictionary(dictionary.get('metricUnit')) if dictionary.get('metricUnit') else None
