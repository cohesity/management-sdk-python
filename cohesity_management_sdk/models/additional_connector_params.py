...
class AdditionalConnectorParams(object):
    ...
    Attributes:
        max_vmware_http_sessions (int): Max http sessions per context for
            VMWare vAPI calls.
        o365_emulator_entity_info (str): A token used only in O365 Emulator
        ...
        registered_entity_sfdc_params (RegisteredEntitySfdcParams):
            ...
            connector params.
            TODO: Fill and send these values from Iris to magneto.
    ...
    def from_dictionary(cls,
        ...
        return cls(max_vmware_http_sessions,
