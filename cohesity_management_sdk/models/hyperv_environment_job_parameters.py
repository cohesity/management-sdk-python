...
class HypervEnvironmentJobParameters(object):

    """Implementation of the 'Hyperv Environment Job Parameters.' model.
    ...
    def __init__(self,
        ...
        """Constructor for the HypervEnvironmentJobParameters class"""
