...
class StorageDomainViewBoxRequest(object):

    """Implementation of the 'Storage Domain (View Box) Request.' model.
    ...
    def __init__(self,
                 ...
                 storage_policy=None,
                 tenant_id_vec=None):
        """Constructor for the StorageDomainViewBoxRequest class"""
