...
class ProtectionSourceSnapshot(object):

    """Implementation of the 'Protection Source Snapshot.' model.
    ...
    Attributes:
        ...
        pagination_cookie (int): Specifies an opaque string to pass into the
            next request to get the next set of Snapshots for pagination
        ...
        run_status (RunStatusEnum): Specifies the type of the Job Run.
            ...
            run to completion.
        run_type (RunType1Enum): Specifies the status of the Job Run.
            ...
            time. 'kSystem' indicates system volume backup. It produces an
    ...
    def __init__(self,
                 ...
                 run_status=None,
                 run_type=None):
        """Constructor for the ProtectionSourceSnapshot class"""
