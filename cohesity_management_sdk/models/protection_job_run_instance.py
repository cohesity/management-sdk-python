...
class ProtectionJobRunInstance(object):

    """Implementation of the 'Protection Job Run Instance.' model.
    ...
    Attributes:
        ...
        copy_run (list of CopyRunTask): Array of Copy Run Tasks.  Specifies
    ...
    def __init__(self,
                 ...
                 job_uid=None,
                 view_box_id=None):
        """Constructor for the ProtectionJobRunInstance class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('copyRun') != None:
            ...
            for structure in dictionary.get('copyRun'):
                copy_run.append(cohesity_management_sdk.models.copy_run_task.CopyRunTask.from_dictionary(structure))
