...
class UpdateAlertResolutionRequest(object):

    """Implementation of the 'Update Alert Resolution Request.' model.
    ...
    def __init__(self,
                 alert_id_list=None):
        """Constructor for the UpdateAlertResolutionRequest class"""
