...
import cohesity_management_sdk.models.restore_o365_public_folders_params_root_public_folder
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rootPublicFolderVec') != None:
            ...
            for structure in dictionary.get('rootPublicFolderVec'):
                root_public_folder_vec.append(cohesity_management_sdk.models.restore_o365_public_folders_params_root_public_folder.RestoreO365PublicFoldersParams_RootPublicFolder.from_dictionary(structure))
