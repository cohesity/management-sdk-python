...
class Dashboard(object):
    ...
    Attributes:
        audit_logs (AuditLogsTile): Audit logs for Dashboard.
        cluster_id (long|int): Id of the cluster for which dashboard is
            given.
        health (HealthTile): Health for Dashboard.
        iops (IOPSTile): IOPs information for dashboard.
        job_runs (JobRunsTile): Jon Runs information.
        protected_objects (ProtectedObjectsTile): Protected Objects
            information.
        protection (ProtectionTile): Protection information and statistics.
        recoveries (RecoveriesTile): Recoveries information.
        storage_efficiency (StorageEfficiencyTile): StorageEfficiencyTile
            gives tile information for the storage saved because of
            compression and dedupe done on the cluster.
        throughput (ThroughputTile): Throughput information for dashboard.
