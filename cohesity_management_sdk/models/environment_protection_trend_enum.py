...
class EnvironmentProtectionTrendEnum(object):

    """Implementation of the 'EnvironmentProtectionTrend' enum.
    Specifies environment. Supported environment types such as 'kView', 'kSQL',
