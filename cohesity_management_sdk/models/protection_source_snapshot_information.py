...
class ProtectionSourceSnapshotInformation(object):
    ...
    Specifies details about a Snapshot that backups up a leaf Protection Source
    Object.
    ...
    Attributes:
        ...
        job_run_start_time_usecs (long|int): Specifies the start time of the
            Job which this object is part of. The time is specified in Unix
            epoch Timestamp (in microseconds).
        last_run_end_time_usecs (long|int): Specifies the end time of the last
            Run of this object's snapshot. The time is specified in Unix epoch
            Timestamp (in microseconds).
        last_run_start_time_usecs (long|int): Specifies the start time of the
            last Run of this object's snapshot. The time is specified in Unix
            epoch Timestamp (in microseconds).
        message (string): Specifies warning or error information when the Job
            Run is not successful.
        num_bytes_read (long|int): Specifies the total number of bytes read.
        num_logical_bytes_protected (long|int): Specifies the total number of
            logical bytes that are protected. The logical size is when the data
        ...
        run_status (RunStatusEnum): Specifies the type of the Job Run.
            ...
            completion.
        run_type (ScheduleTypeEnum): Specifies the status of the Job Run.
            ...
            'kSystem' indicates system volume backup. It produces an image for
            bare metal recovery.
    """
