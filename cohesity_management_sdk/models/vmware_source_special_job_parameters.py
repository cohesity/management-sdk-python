...
class VmwareSourceSpecialJobParameters(object):

    """Implementation of the 'Vmware Source Special Job Parameters.' model.
    ...
    def __init__(self,
                 ...
                 excluded_disks=None,
                 vm_credentials=None):
        """Constructor for the VmwareSourceSpecialJobParameters class"""
