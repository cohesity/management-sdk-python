...
class OnlyOneOfTheFollowingFieldsShouldBeSet(object):

    """Implementation of the 'Only one of the following fields should be set.' model.
    ...
    def __init__(self,
                 ...
                 end_time_usecs=None):
        """Constructor for the OnlyOneOfTheFollowingFieldsShouldBeSet class"""
