...
class ModeSmbPermissionEnum(object):
    ...
    """Implementation of the 'Mode_SmbPermission' enum.
    ...
    and it's sub files. 'kFolderOnly' indicates that permsission are applied
    to folder only. 'kSubFoldersAndFilesOnly' indicates that permissions are
