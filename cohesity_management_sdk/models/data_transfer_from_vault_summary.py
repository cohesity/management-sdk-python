...
class DataTransferFromVaultSummary(object):
    ...
    Attributes:
        ...
        data_transfer_per_task (list of DataTransferFromVaultPerTask): Array of
            Data Transferred Per Task.  Specifies the transfer of data from
            this Vault to this Cohesity Cluster for each clone or recover task.
        num_logical_bytes_transferred (long|int): Specifies the total number of
            logical bytes that have been transferred from this Vault (External
            Target) to this Cohesity Cluster. The logical size is when the data
        ...
        physical_data_transferred_bytes_during_time_range (list of long|int):
            ...
            data transferred from this Vault to the Cohesity Cluster during the
            time period specified using the startTimeMsecs and endTimeMsecs
