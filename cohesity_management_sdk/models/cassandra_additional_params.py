...
class CassandraAdditionalParams(object):
    ...
    Attributes:
        ...
        cassandra_endpoint_snitch (string): Endpoint snitch used for this
            cluster.
        ...
        storage_mbean_name (string): Storage mbean name.
    ...
    _names = {
        ...
        "cassandra_endpoint_snitch": 'cassandraEndpointSnitch',
    ...
    def __init__(self,
        ...
        self.cassandra_endpoint_snitch = cassandra_endpoint_snitch
        ...
        self.storage_mbean_name = storage_mbean_name
    ...
    def from_dictionary(cls,
        ...
        cassandra_endpoint_snitch = dictionary.get('cassandraEndpointSnitch')
        ...
        storage_mbean_name = dictionary.get('storageMbeanName')
        tiered_storage_dirs_map = None
