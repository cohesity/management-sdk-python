...
class SupportedPattern(object):
    ...
    Attributes:
        ...
        pattern_type (PatternTypeEnum): Specifies the Pattern type.
            TODO(Tauseef): Amend the PatternType to be kRegular & KTemplate.
            Future Pattern Types to be added here. 'REGULAR' indicates that
            the pattern contains a regular expression. 'TEMPLATE' indicates
            that the pattern has a pre defined input pattern such as date of
            the form 'DD-MM-YYYY'.
