...
class ServiceStateResult(object):
    ...
    Specifies the result of querying the state of a specific service on the
    Cluster.


    Attributes:

        service (ServiceEnum): Specifies the name of the service. 'kApollo' is
            a service for reclaiming freed disk sectors on Nodes in the SnapFS
            distributed file system. 'kBridge' is a service for managing the
            SnapFS distributed file system. 'kGenie' is a service that is
