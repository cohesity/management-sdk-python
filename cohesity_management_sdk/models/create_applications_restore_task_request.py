...
import cohesity_management_sdk.models.application_server_object_to_restore
import cohesity_management_sdk.models.restore_object
import cohesity_management_sdk.models.vlan_parameters

class CreateApplicationsRestoreTaskRequest(object):

    """Implementation of the 'Create Applications Restore Task Request.' model.
    ...
    Attributes:
        application_environment (ApplicationEnvironmentEnum): Specifies the
            ...
            Source environment.
        application_restore_objects (list of
            ApplicationServerObjectToRestore): Specifies the Application
            Server objects whose data should be restored and the restore
            parameters for each of them.
        hosting_protection_source (RestoreObject): Specifies an object to
    ...
    def __init__(self,
        ...
        """Constructor for the CreateApplicationsRestoreTaskRequest class"""
    ...
    def from_dictionary(cls,
        ...
        hosting_protection_source = cohesity_management_sdk.models.restore_object.RestoreObject.from_dictionary(dictionary.get('hostingProtectionSource')) if dictionary.get('hostingProtectionSource') else None
        ...
        if dictionary.get('applicationRestoreObjects') != None:
            ...
            for structure in dictionary.get('applicationRestoreObjects'):
                application_restore_objects.append(cohesity_management_sdk.models.application_server_object_to_restore.ApplicationServerObjectToRestore.from_dictionary(structure))
