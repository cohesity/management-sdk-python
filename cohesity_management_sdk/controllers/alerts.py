...
from cohesity_management_sdk.models.alert_resolution_1 import AlertResolution1
...
class Alerts(BaseController):

    """A Controller to access Endpoints in the cohesity_management_sdk API."""

    def __init__(self, client=None, call_back=None):
        super(Alerts, self).__init__(client, call_back)
    ...
    def get_alerts(self,
        ...
        Args:
            ...
            alert_category_list (list of AlertCategoryList1Enum, optional):
    ...
    def get_resolutions(self,
        ...
        Returns:
            list of AlertResolution1: Response from the API. Success
