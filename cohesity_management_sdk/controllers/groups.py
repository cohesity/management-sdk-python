...
class Groups(BaseController):

    """A Controller to access Endpoints in the cohesity_management_sdk API."""

    def __init__(self, client=None, call_back=None):
        super(Groups, self).__init__(client, call_back)
    ...
    def delete_groups(self,
        ...
        Args:
            body (DeleteGroupsRequest, optional): Request to delete one or
    ...
    def update_group(self,
        ...
        Args:
            body (GroupRequest, optional): Request to update a group.
