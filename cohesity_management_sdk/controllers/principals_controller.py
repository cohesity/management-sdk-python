...
class PrincipalsController(BaseController):
    ...
    def get_user_api_keys(self, sid, ids=None):
        ...
        try:
            ...
            # Prepare query URL
            self.logger.info('Preparing query URL for get_user_api_keys.')
            ...
            # Prepare headers
            self.logger.info('Preparing headers for get_user_api_keys.')
            _headers = {'accept': 'application/json'}
            ...
            _request = self.http_client.get(_query_url, headers=_headers)
            AuthManager.apply(_request, self.config)
            _context = self.execute_request(_request, name='get_user_api_keys')

            # Endpoint and global error handling using HTTP status codes.
            self.logger.info('Validating response for get_user_api_keys.')
            if _context.response.status_code == 0:
                raise RequestErrorErrorException('Error', _context)
            self.validate_response(_context)
    ...
    def delete_user_api_key(self, sid, id):
        ...
        try:
            ...
            # Validate required parameters
            self.logger.info(
                'Validating required parameters for delete_user_api_key.')
    ...
    def get_user_api_key_by_id(self, sid, id):
    ...
    def update_user_api_key(self, body, sid, id):
        ...
        try:
            ...
            self.validate_parameters(body=body, sid=sid, id=id)
    ...
    def create_rotate_user_api_key(self, sid, id):
        ...
        """
        try:
            self.logger.info('create_rotate_user_api_key called.')

            # Validate required parameters
            self.logger.info(
                'Validating required parameters for create_rotate_user_api_key.'
            )
            self.validate_parameters(sid=sid, id=id)

            # Prepare query URL
            self.logger.info(
                'Preparing query URL for create_rotate_user_api_key.')
            ...
            # Prepare headers
            self.logger.info(
                'Preparing headers for create_rotate_user_api_key.')
            _headers = {'accept': 'application/json'}

            # Prepare and execute request
            self.logger.info(
                'Preparing and executing request for create_rotate_user_api_key.'
            )
            _request = self.http_client.post(_query_url, headers=_headers)
            AuthManager.apply(_request, self.config)
            _context = self.execute_request(_request,
                                            name='create_rotate_user_api_key')

            # Endpoint and global error handling using HTTP status codes.
            self.logger.info(
                'Validating response for create_rotate_user_api_key.')
            if _context.response.status_code == 0:
                raise RequestErrorErrorException('Error', _context)
            self.validate_response(_context)
    ...
    def get_all_user_api_keys(self, user_sids=None):
        ...
        try:
            ...
            # Prepare query URL
            self.logger.info('Preparing query URL for get_all_user_api_keys.')
            ...
            # Endpoint and global error handling using HTTP status codes.
            self.logger.info('Validating response for get_all_user_api_keys.')
            if _context.response.status_code == 0:
                raise RequestErrorErrorException('Error', _context)
            self.validate_response(_context)
