...
from cohesity_management_sdk.models.remote_vault_search_information import RemoteVaultSearchInformation
from cohesity_management_sdk.models.remote_vault_search_job_uid import RemoteVaultSearchJobUid
from cohesity_management_sdk.models.remote_vault_search_job_result import RemoteVaultSearchJobResult
from cohesity_management_sdk.models.remote_vault_restore_task_status import RemoteVaultRestoreTaskStatus
from cohesity_management_sdk.models.unique_global_id import UniqueGlobalId
from cohesity_management_sdk.exceptions.error_error_exception import ErrorErrorException

class RemoteRestore(BaseController):

    """A Controller to access Endpoints in the cohesity_management_sdk API."""

    def __init__(self, client=None, call_back=None):
        super(RemoteRestore, self).__init__(client, call_back)
    ...
    def list_remote_vault_search_jobs(self):
        ...
        Returns:
            list of RemoteVaultSearchInformation: Response from the API.
                Success
    ...
    def create_remote_vault_search_job(self,
        ...
        Args:
            body (CreateRemoteVaultSearchRequest): Request to create a search
                of a remote Vault.

        Returns:
            RemoteVaultSearchJobUid: Response from the API. Success
    ...
    def list_remote_vault_search_job_by_id(self,
        ...
        Returns:
            RemoteVaultSearchInformation: Response from the API. Success
    ...
    def get_remote_vault_search_job_results(self,
        ...
        Returns:
            RemoteVaultSearchJobResult: Response from the API. Success
    ...
    def create_remote_vault_restore_task(self,
        ...
        Args:
            body (CreateRemoteVaultRestoreTaskRequest): Request to create a
                remote Vault restore task.

        Returns:
            UniqueGlobalId: Response from the API. Success
