...
class Principals(BaseController):

    """A Controller to access Endpoints in the cohesity_management_sdk API."""

    def __init__(self, client=None, call_back=None):
        super(Principals, self).__init__(client, call_back)
    ...
    def get_session_user(self):
        ...
        Returns:
            UserDetails: Response from the API. Success
    ...
    def update_user(self,
        ...
        Args:
            body (UserRequest, optional): Request to update an existing user.
    ...
    def create_user(self,
        ...
        Args:
            body (UserRequest, optional): Request to add or create a new
                user.
    ...
    def get_users(self,
        ...
        Returns:
            list of UserDetails: Response from the API. Success
    ...
    def update_sources_for_principals(self,
        ...
        Args:
            body (UpdateSourcesForPrincipalParameters): Request to set access
