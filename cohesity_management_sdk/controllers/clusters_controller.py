...
class ClustersController(BaseController):
    ...
    def destroy_cluster(self):
        ...
        information about the operation and each Node.
    ...
    def create_virtual_cluster(self,
        ...
        returns the IDs, name and software version of the new cluster.
    ...
    def update_upgrade_cluster(self,
        ...
        need to use the /public/packages endpoint to upload a new package to
        the Cluster.
    ...
    def change_service_state(self,
        ...
        services on a Cohesity Cluster and returns a message describing the
        result.
    ...
    def create_expand_physical_cluster(self,
        ...
        returns some information about the request and each new Node.
    ...
    def create_physical_cluster(self,
        ...
        returns the IDs, name, and software version of the new cluster. Also
        returns the status of each node.
    ...
    def get_cluster_creation_progress(self):
        ...
        Cohesity Cluster and returns some information about the creation
        process along with an estimated time remaining and completion
        percentage.
    ...
    def create_expand_cloud_cluster(self,
        ...
        some information about the request and each new Node.
