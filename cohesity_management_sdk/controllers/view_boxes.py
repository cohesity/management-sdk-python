...
from cohesity_management_sdk.models.domain_view_box import DomainViewBox
from cohesity_management_sdk.exceptions.api_exception import APIException
from cohesity_management_sdk.exceptions.error_error_exception import ErrorErrorException

class ViewBoxes(BaseController):

    """A Controller to access Endpoints in the cohesity_management_sdk API."""

    def __init__(self, client=None, call_back=None):
        super(ViewBoxes, self).__init__(client, call_back)
    ...
    def create_view_box(self,
        ...
        Args:
            body (StorageDomainViewBoxRequest): Request to create a Storage
                Domain (View Box) configuration.
