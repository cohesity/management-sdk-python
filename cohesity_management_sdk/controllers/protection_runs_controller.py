...
class ProtectionRunsController(BaseController):
    ...
    def update_protection_runs(self,
        ...
        Protection Job Runs and their snapshots. After an expiration time is
        reached, the Job Run and its snapshots are deleted. If an expiration
        time of 0 is specified, a Job Run and its snapshots are immediately
        deleted.
    ...
    def get_protection_runs(self,
        ...
        If no parameters are specified, Job Runs currently on the Cohesity
        Cluster are returned. Both running and completed Job Runs are
        reported. Specifying parameters filters the results that are
        returned.
        ...
        try:
            ...
            return APIHelper.json_deserialize(_context.response.raw_body, ProtectionRunInstance.from_dictionary)
