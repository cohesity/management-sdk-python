...
class AlertsController(BaseController):
    ...
    def get_alerts(self,
        ...
        Returns all Alert objects found on the Cohesity Cluster that match the
        filter criteria specified using parameters. The Cohesity Cluster
        creates an Alert when a potential problem is found or when a threshold
        has been exceeded on the Cohesity Cluster. If no filter parameters are
        specified, all Alert objects are returned. Each object provides
        details about the Alert such as the Status and Severity.
    ...
    def get_resolutions(self,
        ...
        that match the filter criteria specified using parameters. If no
        filter parameters are specified, all Alert Resolution objects are
        returned. Each object provides details about the Alert Resolution such
        as the resolution summary and details.
    ...
    def get_alert_types(self):
        ...
        filter criteria specified using parameters. If no filter parameters
        are specified, all registered alerts in the Cohesity cluster are
        returned.
    ...
    def create_resolution(self,
        ...
        Create an Alert Resolution and apply it to one or more Alerts. Mark
        the Alerts as resolved.
    ...
    def create_notification_rule(self,
        ...
        email addresses and external apis.
