...
from cohesity_management_sdk.models.smb_active_file_open_response import SMBActiveFileOpenResponse
from cohesity_management_sdk.exceptions.error_error_exception import ErrorErrorException

class SMBFileOpens(BaseController):

    """A Controller to access Endpoints in the cohesity_management_sdk API."""

    def __init__(self, client=None, call_back=None):
        super(SMBFileOpens, self).__init__(client, call_back)
