...
class ViewsController(BaseController):
    ...
    def get_views(self,
        ...
        returned. Specifying parameters filters the results that are returned.
        NOTE: If maxCount is set and the number of Views returned exceeds the
        maxCount, there are more Views to return. To get the next set of
        Views, send another request and specify the id of the last View
        returned in viewList from the previous response.
    ...
    def create_rename_view(self,
        ...
        Specify original name of the View in the 'name' parameter. Returns the
        renamed View.
    ...
    def create_overwrite_view(self,
        ...
        Specifies source and target view names as params. Returns the modified
        Target View.
    ...
    def get_views_by_share_name(self,
        ...
        returned. NOTE: If maxCount is set and the number of Views returned
        exceeds the maxCount, there are more Views to return. To get the next
        set of Views, send another request and specify the pagination cookie
