...
from cohesity.apis.scheduler_api import SchedulerApi
...
class TestSchedulerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = cohesity.apis.scheduler_api.SchedulerApi()

    def tearDown(self):
        pass

    def test_create_scheduler_job(self):
        """
        Test case for create_scheduler_job

        Create an email report scheduler job.
        """
        pass

    def test_delete_scheduler_jobs(self):
        """
        Test case for delete_scheduler_jobs
    ...
    def test_get_scheduler_jobs(self):
        """
        Test case for get_scheduler_jobs
    ...
    def test_update_scheduler_job(self):
        """
        Test case for update_scheduler_job
