...
from cohesity.apis.audit_api import AuditApi
...
class TestAuditApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = cohesity.apis.audit_api.AuditApi()

    def tearDown(self):
        pass

    def test_search_cluster_audit_logs(self):
        """
        Test case for search_cluster_audit_logs
