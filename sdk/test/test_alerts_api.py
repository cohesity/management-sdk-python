...
from cohesity.apis.alerts_api import AlertsApi
...
class TestAlertsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = cohesity.apis.alerts_api.AlertsApi()
    ...
    def test_get_resolution_by_id(self):
        """
        Test case for get_resolution_by_id
