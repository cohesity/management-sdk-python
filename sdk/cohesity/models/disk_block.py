...
class DiskBlock(object):
    ...
    """
    def __init__(self, length_bytes=None, offset_bytes=None):
        """
        DiskBlock - a model defined in Swagger
    ...
    def length_bytes(self):
        """
        Gets the length_bytes of this DiskBlock.
        Specifies the length of the block in bytes.

        :return: The length_bytes of this DiskBlock.
        :rtype: int
        """
    ...
    def length_bytes(self, length_bytes):
        """
        Sets the length_bytes of this DiskBlock.
        Specifies the length of the block in bytes.

        :param length_bytes: The length_bytes of this DiskBlock.
        :type: int
        """
    ...
    def offset_bytes(self):
        """
        Gets the offset_bytes of this DiskBlock.
        ...
        :return: The offset_bytes of this DiskBlock.
        :rtype: int
        """
    ...
    def offset_bytes(self, offset_bytes):
        """
        Sets the offset_bytes of this DiskBlock.
        Specifies the offset of the block (in bytes) from the beginning of the containing object such as a physical disk or a virtual disk file.

        :param offset_bytes: The offset_bytes of this DiskBlock.
        :type: int
        """
