...
class RunJobSnapshotTarget(object):
    ...
    """
    def __init__(self, archival_target=None, days_to_keep=None, replication_target=None, type=None):
        """
        RunJobSnapshotTarget - a model defined in Swagger
    ...
    def archival_target(self):
        """
        Gets the archival_target of this RunJobSnapshotTarget.
        ...
        :return: The archival_target of this RunJobSnapshotTarget.
    ...
    def archival_target(self, archival_target):
        """
        Sets the archival_target of this RunJobSnapshotTarget.
        Specifies the Archival External Target for storing a copied Snapshot. If the type is not 'kLocal', either a replicationTarget or archivalTarget must be specified.

        :param archival_target: The archival_target of this RunJobSnapshotTarget.
        :type: ArchivalTarget
        """
    ...
    def days_to_keep(self):
        """
        Gets the days_to_keep of this RunJobSnapshotTarget.
        Specifies the number of days to retain copied Snapshots on the target.

        :return: The days_to_keep of this RunJobSnapshotTarget.
        :rtype: int
        """
    ...
    def days_to_keep(self, days_to_keep):
        """
        Sets the days_to_keep of this RunJobSnapshotTarget.
        Specifies the number of days to retain copied Snapshots on the target.

        :param days_to_keep: The days_to_keep of this RunJobSnapshotTarget.
        :type: int
        """
    ...
    def replication_target(self):
        """
        Gets the replication_target of this RunJobSnapshotTarget.
        ...
        :return: The replication_target of this RunJobSnapshotTarget.
    ...
    def replication_target(self, replication_target):
        """
        Sets the replication_target of this RunJobSnapshotTarget.
        Specifies the replication target (Remote Cluster) for storing a copied Snapshot. If the type is not 'kLocal', either a replicationTarget or archivalTarget must be specified.

        :param replication_target: The replication_target of this RunJobSnapshotTarget.
    ...
    def type(self):
        """
        Gets the type of this RunJobSnapshotTarget.
        ...
        :return: The type of this RunJobSnapshotTarget.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this RunJobSnapshotTarget.
        Specifies the type of a Snapshot target such as 'kLocal', 'kRemote' or 'kArchival'. 'kLocal' means the Snapshot is stored on a local Cohesity Cluster. 'kRemote' means the Snapshot is stored on a Remote Cohesity Cluster. (It was copied to the Remote Cohesity Cluster using replication.) 'kArchival' means the Snapshot is stored on a Archival External Target (such as Tape or AWS).

        :param type: The type of this RunJobSnapshotTarget.
        :type: str
        """
