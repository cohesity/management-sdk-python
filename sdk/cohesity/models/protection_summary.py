...
class ProtectionSummary(object):
    ...
    def __init__(self, protected_count=None, protected_size=None, unprotected_count=None, unprotected_size=None):
        """
        ProtectionSummary - a model defined in Swagger
    ...
    def protected_count(self):
        """
        Gets the protected_count of this ProtectionSummary.
        Specifies the number of objects that are protected under the given entity.

        :return: The protected_count of this ProtectionSummary.
        :rtype: int
        """
    ...
    def protected_count(self, protected_count):
        """
        Sets the protected_count of this ProtectionSummary.
        Specifies the number of objects that are protected under the given entity.

        :param protected_count: The protected_count of this ProtectionSummary.
        :type: int
        """
    ...
    def protected_size(self):
        """
        Gets the protected_size of this ProtectionSummary.
        Specifies the total size of the protected objects under the given entity.

        :return: The protected_size of this ProtectionSummary.
        :rtype: int
        """
    ...
    def protected_size(self, protected_size):
        """
        Sets the protected_size of this ProtectionSummary.
        Specifies the total size of the protected objects under the given entity.

        :param protected_size: The protected_size of this ProtectionSummary.
        :type: int
        """
    ...
    def unprotected_count(self):
        """
        Gets the unprotected_count of this ProtectionSummary.
        Specifies the number of objects that are not protected under the given entity.

        :return: The unprotected_count of this ProtectionSummary.
        :rtype: int
        """
    ...
    def unprotected_count(self, unprotected_count):
        """
        Sets the unprotected_count of this ProtectionSummary.
        Specifies the number of objects that are not protected under the given entity.

        :param unprotected_count: The unprotected_count of this ProtectionSummary.
        :type: int
        """
    ...
    def unprotected_size(self):
        """
        Gets the unprotected_size of this ProtectionSummary.
        Specifies the total size of the unprotected objects under the given entity.

        :return: The unprotected_size of this ProtectionSummary.
        :rtype: int
        """
    ...
    def unprotected_size(self, unprotected_size):
        """
        Sets the unprotected_size of this ProtectionSummary.
        Specifies the total size of the unprotected objects under the given entity.

        :param unprotected_size: The unprotected_size of this ProtectionSummary.
        :type: int
        """
