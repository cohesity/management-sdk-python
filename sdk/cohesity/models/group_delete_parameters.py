...
class GroupDeleteParameters(object):
    ...
    """
    def __init__(self, domain=None, names=None):
        """
        GroupDeleteParameters - a model defined in Swagger
    ...
    def domain(self):
        """
        Gets the domain of this GroupDeleteParameters.
        ...
        :return: The domain of this GroupDeleteParameters.
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        """
        Sets the domain of this GroupDeleteParameters.
        Specifies the domain associated with the groups to delete. Only groups associated with the same domain can be deleted by a single request. If no domain is specified, the specified groups are deleted from the LOCAL domain on the Cohesity Cluster. If a non-LOCAL domain is specified, the specified groups are deleted on the Cohesity Cluster. However, the referenced group principals on the Active Directory are not deleted.

        :param domain: The domain of this GroupDeleteParameters.
        :type: str
        """
    ...
    def names(self):
        """
        Gets the names of this GroupDeleteParameters.
        ...
        :return: The names of this GroupDeleteParameters.
        :rtype: list[str]
        """
        return self._names
    ...
    def names(self, names):
        """
        Sets the names of this GroupDeleteParameters.
        Specifies the list of groups to delete on the Cohesity Cluster. Only groups from the same domain can be deleted by a single request.

        :param names: The names of this GroupDeleteParameters.
        :type: list[str]
        """
