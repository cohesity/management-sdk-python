...
class ProtectionPolicyRequest(object):
    ...
    def blackout_periods(self):
        """
        Gets the blackout_periods of this ProtectionPolicyRequest.
        ...
        :return: The blackout_periods of this ProtectionPolicyRequest.
    ...
    def blackout_periods(self, blackout_periods):
        """
        Sets the blackout_periods of this ProtectionPolicyRequest.
        If specified, this field defines black periods when new Job Runs are not started. If a Job Run has been scheduled but not yet executed and the blackout period starts, the behavior depends on the policy field AbortInBlackoutPeriod.

        :param blackout_periods: The blackout_periods of this ProtectionPolicyRequest.
    ...
    def cloud_deploy_policies(self):
        """
        Gets the cloud_deploy_policies of this ProtectionPolicyRequest.
        ...
        :return: The cloud_deploy_policies of this ProtectionPolicyRequest.
    ...
    def cloud_deploy_policies(self, cloud_deploy_policies):
        """
        Sets the cloud_deploy_policies of this ProtectionPolicyRequest.
        Specifies settings for copying Snapshots to Cloud. CloudDeploy target where backup snapshots may be converted and stored. It also defines the retention of copied Snapshots on the Cloud.

        :param cloud_deploy_policies: The cloud_deploy_policies of this ProtectionPolicyRequest.
    ...
    def days_to_keep(self):
        """
        Gets the days_to_keep of this ProtectionPolicyRequest.
        Specifies how many days to retain Snapshots on the Cohesity Cluster.

        :return: The days_to_keep of this ProtectionPolicyRequest.
        :rtype: int
        """
    ...
    def days_to_keep(self, days_to_keep):
        """
        Sets the days_to_keep of this ProtectionPolicyRequest.
        Specifies how many days to retain Snapshots on the Cohesity Cluster.

        :param days_to_keep: The days_to_keep of this ProtectionPolicyRequest.
        :type: int
        """
    ...
    def days_to_keep_log(self):
        """
        Gets the days_to_keep_log of this ProtectionPolicyRequest.
        Specifies the number of days to retain log run if Log Schedule exists.

        :return: The days_to_keep_log of this ProtectionPolicyRequest.
        :rtype: int
        """
    ...
    def days_to_keep_log(self, days_to_keep_log):
        """
        Sets the days_to_keep_log of this ProtectionPolicyRequest.
        Specifies the number of days to retain log run if Log Schedule exists.

        :param days_to_keep_log: The days_to_keep_log of this ProtectionPolicyRequest.
        :type: int
        """
    ...
    def days_to_keep_system(self):
        """
        Gets the days_to_keep_system of this ProtectionPolicyRequest.
        ...
        :return: The days_to_keep_system of this ProtectionPolicyRequest.
        :rtype: int
        """
    ...
    def days_to_keep_system(self, days_to_keep_system):
        """
        Sets the days_to_keep_system of this ProtectionPolicyRequest.
        Specifies the number of days to retain system backups made for bare metal recovery. This field is applicable if systemSchedulingPolicy is specified.

        :param days_to_keep_system: The days_to_keep_system of this ProtectionPolicyRequest.
        :type: int
        """
    ...
    def description(self):
        """
        Gets the description of this ProtectionPolicyRequest.
        Description of the Protection Policy.

        :return: The description of this ProtectionPolicyRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this ProtectionPolicyRequest.
        Description of the Protection Policy.

        :param description: The description of this ProtectionPolicyRequest.
        :type: str
        """
    ...
    def extended_retention_policies(self):
        """
        Gets the extended_retention_policies of this ProtectionPolicyRequest.
        ...
        :return: The extended_retention_policies of this ProtectionPolicyRequest.
    ...
    def extended_retention_policies(self, extended_retention_policies):
        """
        Sets the extended_retention_policies of this ProtectionPolicyRequest.
        Specifies additional retention policies that should be applied to the backup snapshots. A backup snapshot will be retained up to a time that is the maximum of all retention policies that are applicable to it.

        :param extended_retention_policies: The extended_retention_policies of this ProtectionPolicyRequest.
    ...
    def full_scheduling_policy(self):
        """
        Gets the full_scheduling_policy of this ProtectionPolicyRequest.


        :return: The full_scheduling_policy of this ProtectionPolicyRequest.
    ...
    def full_scheduling_policy(self, full_scheduling_policy):
        """
        Sets the full_scheduling_policy of this ProtectionPolicyRequest.


        :param full_scheduling_policy: The full_scheduling_policy of this ProtectionPolicyRequest.
    ...
    def incremental_scheduling_policy(self):
        """
        Gets the incremental_scheduling_policy of this ProtectionPolicyRequest.


        :return: The incremental_scheduling_policy of this ProtectionPolicyRequest.
    ...
    def incremental_scheduling_policy(self, incremental_scheduling_policy):
        """
        Sets the incremental_scheduling_policy of this ProtectionPolicyRequest.


        :param incremental_scheduling_policy: The incremental_scheduling_policy of this ProtectionPolicyRequest.
    ...
    def log_scheduling_policy(self):
        """
        Gets the log_scheduling_policy of this ProtectionPolicyRequest.
        ...
        :return: The log_scheduling_policy of this ProtectionPolicyRequest.
    ...
    def log_scheduling_policy(self, log_scheduling_policy):
        """
        Sets the log_scheduling_policy of this ProtectionPolicyRequest.
        Specifies the Log backup schedule of a Protection Job and how long log files captured by this schedule are retained on the Cohesity Cluster.

        :param log_scheduling_policy: The log_scheduling_policy of this ProtectionPolicyRequest.
    ...
    def name(self):
        """
        Gets the name of this ProtectionPolicyRequest.
        Specifies the name of the Protection Policy.

        :return: The name of this ProtectionPolicyRequest.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this ProtectionPolicyRequest.
        Specifies the name of the Protection Policy.

        :param name: The name of this ProtectionPolicyRequest.
        :type: str
        """
    ...
    def retries(self):
        """
        Gets the retries of this ProtectionPolicyRequest.
        Specifies the number of times to retry capturing Snapshots before the Job Run fails.

        :return: The retries of this ProtectionPolicyRequest.
        :rtype: int
        """
    ...
    def retries(self, retries):
        """
        Sets the retries of this ProtectionPolicyRequest.
        Specifies the number of times to retry capturing Snapshots before the Job Run fails.

        :param retries: The retries of this ProtectionPolicyRequest.
        :type: int
        """
    ...
    def retry_interval_mins(self):
        """
        Gets the retry_interval_mins of this ProtectionPolicyRequest.
        Specifies the number of minutes before retrying a failed Protection Job.

        :return: The retry_interval_mins of this ProtectionPolicyRequest.
        :rtype: int
        """
    ...
    def retry_interval_mins(self, retry_interval_mins):
        """
        Sets the retry_interval_mins of this ProtectionPolicyRequest.
        Specifies the number of minutes before retrying a failed Protection Job.

        :param retry_interval_mins: The retry_interval_mins of this ProtectionPolicyRequest.
        :type: int
        """
    ...
    def skip_interval_mins(self):
        """
        Gets the skip_interval_mins of this ProtectionPolicyRequest.
        ...
        :return: The skip_interval_mins of this ProtectionPolicyRequest.
        :rtype: int
        """
    ...
    def skip_interval_mins(self, skip_interval_mins):
        """
        Sets the skip_interval_mins of this ProtectionPolicyRequest.
        Specifies the period of time before skipping the execution of new Job Runs if an existing queued Job Run of the same Protection Job has not started. For example if this field is set to 30 minutes and a Job Run is scheduled to start at 5:00 AM every day but does not start due to conflicts (such as too many Jobs are running). If the new Job Run does not start by 5:30AM, the Cohesity Cluster will skip the new Job Run. If the original Job Run completes before 5:30AM the next day, a new Job Run is created and starts executing. This field is optional.

        :param skip_interval_mins: The skip_interval_mins of this ProtectionPolicyRequest.
        :type: int
        """
    ...
    def snapshot_archival_copy_policies(self):
        """
        Gets the snapshot_archival_copy_policies of this ProtectionPolicyRequest.
        ...
        :return: The snapshot_archival_copy_policies of this ProtectionPolicyRequest.
    ...
    def snapshot_archival_copy_policies(self, snapshot_archival_copy_policies):
        """
        Sets the snapshot_archival_copy_policies of this ProtectionPolicyRequest.
        Specifies settings for copying Snapshots to  Archival External Targets (such as AWS or Tape). It also defines the retention of copied Snapshots on an External Targets such as AWS and Tape.

        :param snapshot_archival_copy_policies: The snapshot_archival_copy_policies of this ProtectionPolicyRequest.
    ...
    def snapshot_replication_copy_policies(self):
        """
        Gets the snapshot_replication_copy_policies of this ProtectionPolicyRequest.
        ...
        :return: The snapshot_replication_copy_policies of this ProtectionPolicyRequest.
    ...
    def snapshot_replication_copy_policies(self, snapshot_replication_copy_policies):
        """
        Sets the snapshot_replication_copy_policies of this ProtectionPolicyRequest.
        Specifies settings for copying Snapshots to Remote Clusters. It also defines the retention of copied Snapshots on a Remote Cluster.

        :param snapshot_replication_copy_policies: The snapshot_replication_copy_policies of this ProtectionPolicyRequest.
    ...
    def system_scheduling_policy(self):
        """
        Gets the system_scheduling_policy of this ProtectionPolicyRequest.
        ...
        :return: The system_scheduling_policy of this ProtectionPolicyRequest.
        :rtype: SchedulingPolicy
        """
    ...
    def system_scheduling_policy(self, system_scheduling_policy):
        """
        Sets the system_scheduling_policy of this ProtectionPolicyRequest.
        Specifies the system backup schedule for agents running on servers to run low frequency backup jobs. Images created as part of the backup can be used to perform a \"bare metal\" recovery.

        :param system_scheduling_policy: The system_scheduling_policy of this ProtectionPolicyRequest.
        :type: SchedulingPolicy
        """
