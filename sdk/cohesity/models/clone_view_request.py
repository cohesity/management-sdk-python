...
class CloneViewRequest(object):
    ...
    def __init__(self, access_sids=None, clone_view_name=None, data_lock_expiry_usecs=None, description=None, enable_filer_audit_logging=None, enable_mixed_mode_permissions=None, enable_smb_access_based_enumeration=None, enable_smb_view_discovery=None, file_extension_filter=None, logical_quota=None, protocol_access=None, qos=None, smb_permissions_info=None, source_view_name=None, storage_policy_override=None, subnet_whitelist=None):
        """
        CloneViewRequest - a model defined in Swagger
    ...
    def access_sids(self, access_sids):
        """
        Sets the access_sids of this CloneViewRequest.
        Specifies the list of security identifiers (SIDs) for the restricted Principals who have access to this View.

        :param access_sids: The access_sids of this CloneViewRequest.
        :type: list[str]
        """
    ...
    def clone_view_name(self):
        """
        Gets the clone_view_name of this CloneViewRequest.
        Specifies the name of the new View that is cloned from the source View.

        :return: The clone_view_name of this CloneViewRequest.
        :rtype: str
        """
    ...
    def clone_view_name(self, clone_view_name):
        """
        Sets the clone_view_name of this CloneViewRequest.
        Specifies the name of the new View that is cloned from the source View.

        :param clone_view_name: The clone_view_name of this CloneViewRequest.
        :type: str
        """
    ...
    def data_lock_expiry_usecs(self):
        """
        Gets the data_lock_expiry_usecs of this CloneViewRequest.
        ...
        :return: The data_lock_expiry_usecs of this CloneViewRequest.
        :rtype: int
        """
    ...
    def data_lock_expiry_usecs(self, data_lock_expiry_usecs):
        """
        Sets the data_lock_expiry_usecs of this CloneViewRequest.
        DataLock (Write Once Read Many) lock expiry epoch time in microseconds. If specified, a view will be marked as a DataLock view. If a view is marked as a DataLock view, only a Data Security Officer (a user having Data Security Privilege) can delete the view until the lock expiry time.

        :param data_lock_expiry_usecs: The data_lock_expiry_usecs of this CloneViewRequest.
        :type: int
        """
    ...
    def description(self):
        """
        Gets the description of this CloneViewRequest.
        Specifies an optional text description about the View.

        :return: The description of this CloneViewRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this CloneViewRequest.
        Specifies an optional text description about the View.

        :param description: The description of this CloneViewRequest.
        :type: str
        """
    ...
    def enable_filer_audit_logging(self):
        """
        Gets the enable_filer_audit_logging of this CloneViewRequest.
        Specifies if Filer Audit Logging is enabled for this view.

        :return: The enable_filer_audit_logging of this CloneViewRequest.
        :rtype: bool
        """
    ...
    def enable_filer_audit_logging(self, enable_filer_audit_logging):
        """
        Sets the enable_filer_audit_logging of this CloneViewRequest.
        Specifies if Filer Audit Logging is enabled for this view.

        :param enable_filer_audit_logging: The enable_filer_audit_logging of this CloneViewRequest.
        :type: bool
        """
    ...
    def enable_mixed_mode_permissions(self):
        """
        Gets the enable_mixed_mode_permissions of this CloneViewRequest.
        If set, mixed mode (NFS and SMB) access is enabled for this view.

        :return: The enable_mixed_mode_permissions of this CloneViewRequest.
        :rtype: bool
        """
    ...
    def enable_mixed_mode_permissions(self, enable_mixed_mode_permissions):
        """
        Sets the enable_mixed_mode_permissions of this CloneViewRequest.
        If set, mixed mode (NFS and SMB) access is enabled for this view.

        :param enable_mixed_mode_permissions: The enable_mixed_mode_permissions of this CloneViewRequest.
        :type: bool
        """
    ...
    def enable_smb_access_based_enumeration(self):
        """
        Gets the enable_smb_access_based_enumeration of this CloneViewRequest.
        ...
        :return: The enable_smb_access_based_enumeration of this CloneViewRequest.
        :rtype: bool
        """
    ...
    def enable_smb_access_based_enumeration(self, enable_smb_access_based_enumeration):
        """
        Sets the enable_smb_access_based_enumeration of this CloneViewRequest.
        Specifies if access-based enumeration should be enabled. If 'true', only files and folders that the user has permissions to access are visible on the SMB share for that user.

        :param enable_smb_access_based_enumeration: The enable_smb_access_based_enumeration of this CloneViewRequest.
        :type: bool
        """
    ...
    def enable_smb_view_discovery(self):
        """
        Gets the enable_smb_view_discovery of this CloneViewRequest.
        If set, it enables discovery of view for SMB.

        :return: The enable_smb_view_discovery of this CloneViewRequest.
        :rtype: bool
        """
    ...
    def enable_smb_view_discovery(self, enable_smb_view_discovery):
        """
        Sets the enable_smb_view_discovery of this CloneViewRequest.
        If set, it enables discovery of view for SMB.

        :param enable_smb_view_discovery: The enable_smb_view_discovery of this CloneViewRequest.
        :type: bool
        """
    ...
    def file_extension_filter(self):
        """
        Gets the file_extension_filter of this CloneViewRequest.
        ...
        :return: The file_extension_filter of this CloneViewRequest.
    ...
    def file_extension_filter(self, file_extension_filter):
        """
        Sets the file_extension_filter of this CloneViewRequest.
        Optional filtering criteria that should be satisfied by all the files created in this view. It does not affect existing files.

        :param file_extension_filter: The file_extension_filter of this CloneViewRequest.
    ...
    def logical_quota(self):
        """
        Gets the logical_quota of this CloneViewRequest.


        :return: The logical_quota of this CloneViewRequest.
    ...
    def logical_quota(self, logical_quota):
        """
        Sets the logical_quota of this CloneViewRequest.


        :param logical_quota: The logical_quota of this CloneViewRequest.
    ...
    def protocol_access(self):
        """
        Gets the protocol_access of this CloneViewRequest.
        Specifies the supported Protocols for the View.

        :return: The protocol_access of this CloneViewRequest.
        :rtype: str
        """
    ...
    def protocol_access(self, protocol_access):
        """
        Sets the protocol_access of this CloneViewRequest.
        Specifies the supported Protocols for the View.

        :param protocol_access: The protocol_access of this CloneViewRequest.
        :type: str
        """
    ...
    def qos(self):
        """
        Gets the qos of this CloneViewRequest.
        Specifies the Quality of Service (QoS) Policy for the View.

        :return: The qos of this CloneViewRequest.
        :rtype: QoS
        """
        return self._qos
    ...
    def qos(self, qos):
        """
        Sets the qos of this CloneViewRequest.
        Specifies the Quality of Service (QoS) Policy for the View.

        :param qos: The qos of this CloneViewRequest.
        :type: QoS
        """
    ...
    def smb_permissions_info(self):
        """
        Gets the smb_permissions_info of this CloneViewRequest.
        Specifies the SMB permissions for the View.

        :return: The smb_permissions_info of this CloneViewRequest.
    ...
    def smb_permissions_info(self, smb_permissions_info):
        """
        Sets the smb_permissions_info of this CloneViewRequest.
        Specifies the SMB permissions for the View.

        :param smb_permissions_info: The smb_permissions_info of this CloneViewRequest.
    ...
    def source_view_name(self):
        """
        Gets the source_view_name of this CloneViewRequest.
        Specifies the name of the source View that will be cloned.

        :return: The source_view_name of this CloneViewRequest.
        :rtype: str
        """
    ...
    def source_view_name(self, source_view_name):
        """
        Sets the source_view_name of this CloneViewRequest.
        Specifies the name of the source View that will be cloned.

        :param source_view_name: The source_view_name of this CloneViewRequest.
        :type: str
        """
    ...
    def storage_policy_override(self):
        """
        Gets the storage_policy_override of this CloneViewRequest.
        ...
        :return: The storage_policy_override of this CloneViewRequest.
    ...
    def storage_policy_override(self, storage_policy_override):
        """
        Sets the storage_policy_override of this CloneViewRequest.
        Specifies if inline deduplication and compression settings inherited from the Storage Domain (View Box) should be disabled for this View.

        :param storage_policy_override: The storage_policy_override of this CloneViewRequest.
    ...
    def subnet_whitelist(self):
        """
        Gets the subnet_whitelist of this CloneViewRequest.
        ...
        :return: The subnet_whitelist of this CloneViewRequest.
        :rtype: list[Subnet]
        """
    ...
    def subnet_whitelist(self, subnet_whitelist):
        """
        Sets the subnet_whitelist of this CloneViewRequest.
        Specifies a list of Subnets with IP addresses that have permissions to access the View. (Overrides the Subnets specified at the global Cohesity Cluster level.)

        :param subnet_whitelist: The subnet_whitelist of this CloneViewRequest.
        :type: list[Subnet]
        """
