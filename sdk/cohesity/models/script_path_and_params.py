...
class ScriptPathAndParams(object):
    ...
    def __init__(self, script_params=None, script_path=None):
        """
        ScriptPathAndParams - a model defined in Swagger
    ...
    def script_params(self):
        """
        Gets the script_params of this ScriptPathAndParams.
        ...
        :return: The script_params of this ScriptPathAndParams.
        :rtype: str
        """
    ...
    def script_params(self, script_params):
        """
        Sets the script_params of this ScriptPathAndParams.
        Specifies the parameters and values to pass into the remote script. For example if the script expects values for the 'database' and 'user' parameters, specify the parameters and values using the following string: \"database=myDatabase user=me\".

        :param script_params: The script_params of this ScriptPathAndParams.
        :type: str
        """
    ...
    def script_path(self):
        """
        Gets the script_path of this ScriptPathAndParams.
        Specifies the path to the script on the remote host.

        :return: The script_path of this ScriptPathAndParams.
        :rtype: str
        """
    ...
    def script_path(self, script_path):
        """
        Sets the script_path of this ScriptPathAndParams.
        Specifies the path to the script on the remote host.

        :param script_path: The script_path of this ScriptPathAndParams.
        :type: str
        """
