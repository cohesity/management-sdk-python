...
class HypervEnvJobParameters(object):
    ...
    """
    def __init__(self, fallback_to_crash_consistent=None):
        """
        HypervEnvJobParameters - a model defined in Swagger
    ...
    def fallback_to_crash_consistent(self):
        """
        Gets the fallback_to_crash_consistent of this HypervEnvJobParameters.
        ...
        :return: The fallback_to_crash_consistent of this HypervEnvJobParameters.
        :rtype: bool
        """
    ...
    def fallback_to_crash_consistent(self, fallback_to_crash_consistent):
        """
        Sets the fallback_to_crash_consistent of this HypervEnvJobParameters.
        If true, takes a crash-consistent snapshot when app-consistent snapshot fails. Otherwise, the snapshot attempt is marked failed. By default, this field is set to false.

        :param fallback_to_crash_consistent: The fallback_to_crash_consistent of this HypervEnvJobParameters.
        :type: bool
        """
