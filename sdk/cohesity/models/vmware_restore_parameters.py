...
class VmwareRestoreParameters(object):
    ...
    """
    def __init__(self, datastore_folder_id=None, datastore_id=None, disable_network=None, network_id=None, powered_on=None, prefix=None, resource_pool_id=None, suffix=None, vm_folder_id=None):
        """
        VmwareRestoreParameters - a model defined in Swagger
    ...
    def datastore_folder_id(self):
        """
        Gets the datastore_folder_id of this VmwareRestoreParameters.
        Specifies the folder where the restore datastore should be created. This is applicable only when the VMs are being cloned.

        :return: The datastore_folder_id of this VmwareRestoreParameters.
        :rtype: int
        """
    ...
    def datastore_folder_id(self, datastore_folder_id):
        """
        Sets the datastore_folder_id of this VmwareRestoreParameters.
        Specifies the folder where the restore datastore should be created. This is applicable only when the VMs are being cloned.

        :param datastore_folder_id: The datastore_folder_id of this VmwareRestoreParameters.
        :type: int
        """
    ...
    def datastore_id(self):
        """
        Gets the datastore_id of this VmwareRestoreParameters.
        ...
        :return: The datastore_id of this VmwareRestoreParameters.
        :rtype: int
        """
    ...
    def datastore_id(self, datastore_id):
        """
        Sets the datastore_id of this VmwareRestoreParameters.
        Specifies the datastore where the object's files should be recovered to. This field is mandatory to recover objects to a different resource pool or to a different parent source. If not specified, objects are recovered to their original datastore locations in the parent source.

        :param datastore_id: The datastore_id of this VmwareRestoreParameters.
        :type: int
        """
    ...
    def disable_network(self):
        """
        Gets the disable_network of this VmwareRestoreParameters.
        ...
        :return: The disable_network of this VmwareRestoreParameters.
        :rtype: bool
        """
    ...
    def disable_network(self, disable_network):
        """
        Sets the disable_network of this VmwareRestoreParameters.
        Specifies whether the network should be left in disabled state. Attached network is enabled by default. Set this flag to true to disable it.

        :param disable_network: The disable_network of this VmwareRestoreParameters.
        :type: bool
        """
    ...
    def network_id(self):
        """
        Gets the network_id of this VmwareRestoreParameters.
        ...
        :return: The network_id of this VmwareRestoreParameters.
        :rtype: int
        """
    ...
    def network_id(self, network_id):
        """
        Sets the network_id of this VmwareRestoreParameters.
        Specifies a network configuration to be attached to the cloned or recovered object. For kCloneVMs and kRecoverVMs tasks, original network configuration is detached if the cloned or recovered object is kept under a different parent Protection Source or a different Resource Pool. By default, for kRecoverVMs task, original network configuration is preserved if the recovered object is kept under the same parent Protection Source and the same Resource Pool. Specify this field to override the preserved network configuration or to attach a new network configuration to the cloned or recovered objects. You can get the networkId of the kNetwork object by setting includeNetworks to 'true' in the GET /public/protectionSources operation. In the response, get the id of the desired kNetwork object, the resource pool, and the registered parent Protection Source.

        :param network_id: The network_id of this VmwareRestoreParameters.
        :type: int
        """
    ...
    def powered_on(self, powered_on):
        """
        Sets the powered_on of this VmwareRestoreParameters.
        Specifies the power state of the cloned or recovered objects. By default, the cloned or recovered objects are powered off.

        :param powered_on: The powered_on of this VmwareRestoreParameters.
        :type: bool
        """
    ...
    def prefix(self):
        """
        Gets the prefix of this VmwareRestoreParameters.
        ...
        :return: The prefix of this VmwareRestoreParameters.
        :rtype: str
        """
        return self._prefix
    ...
    def prefix(self, prefix):
        """
        Sets the prefix of this VmwareRestoreParameters.
        Specifies a prefix to prepended to the source object name to derive a new name for the recovered or cloned object. By default, cloned or recovered objects retain their original name. Length of this field is limited to 8 characters.

        :param prefix: The prefix of this VmwareRestoreParameters.
        :type: str
        """
    ...
    def resource_pool_id(self):
        """
        Gets the resource_pool_id of this VmwareRestoreParameters.
        ...
        :return: The resource_pool_id of this VmwareRestoreParameters.
        :rtype: int
        """
    ...
    def resource_pool_id(self, resource_pool_id):
        """
        Sets the resource_pool_id of this VmwareRestoreParameters.
        Specifies the resource pool where the cloned or recovered objects are attached. This field is mandatory for kCloneVMs Restore Tasks always. For kRecoverVMs Restore Tasks, this field is mandatory only if newParentId field is specified. If this field is not specified, recovered objects are attached to the original resource pool under the original parent.

        :param resource_pool_id: The resource_pool_id of this VmwareRestoreParameters.
        :type: int
        """
    ...
    def suffix(self):
        """
        Gets the suffix of this VmwareRestoreParameters.
        ...
        :return: The suffix of this VmwareRestoreParameters.
        :rtype: str
        """
        return self._suffix
    ...
    def suffix(self, suffix):
        """
        Sets the suffix of this VmwareRestoreParameters.
        Specifies a suffix to appended to the original source object name to derive a new name for the recovered or cloned object. By default, cloned or recovered objects retain their original name. Length of this field is limited to 8 characters.

        :param suffix: The suffix of this VmwareRestoreParameters.
        :type: str
        """
    ...
    def vm_folder_id(self):
        """
        Gets the vm_folder_id of this VmwareRestoreParameters.
        ...
        :return: The vm_folder_id of this VmwareRestoreParameters.
        :rtype: int
        """
    ...
    def vm_folder_id(self, vm_folder_id):
        """
        Sets the vm_folder_id of this VmwareRestoreParameters.
        Specifies a folder where the VMs should be restored. This is applicable only when the VMs are being restored to an alternate location or if clone is being performed.

        :param vm_folder_id: The vm_folder_id of this VmwareRestoreParameters.
        :type: int
        """
