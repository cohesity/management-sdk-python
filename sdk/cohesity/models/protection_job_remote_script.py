...
class ProtectionJobRemoteScript(object):
    """
    ...
    def __init__(self, full_backup_script=None, incremental_backup_script=None, log_backup_script=None, remote_host=None, username=None):
        """
        ProtectionJobRemoteScript - a model defined in Swagger
    ...
    def full_backup_script(self):
        """
        Gets the full_backup_script of this ProtectionJobRemoteScript.


        :return: The full_backup_script of this ProtectionJobRemoteScript.
    ...
    def full_backup_script(self, full_backup_script):
        """
        Sets the full_backup_script of this ProtectionJobRemoteScript.


        :param full_backup_script: The full_backup_script of this ProtectionJobRemoteScript.
    ...
    def incremental_backup_script(self):
        """
        Gets the incremental_backup_script of this ProtectionJobRemoteScript.


        :return: The incremental_backup_script of this ProtectionJobRemoteScript.
    ...
    def incremental_backup_script(self, incremental_backup_script):
        """
        Sets the incremental_backup_script of this ProtectionJobRemoteScript.


        :param incremental_backup_script: The incremental_backup_script of this ProtectionJobRemoteScript.
    ...
    def log_backup_script(self):
        """
        Gets the log_backup_script of this ProtectionJobRemoteScript.


        :return: The log_backup_script of this ProtectionJobRemoteScript.
    ...
    def log_backup_script(self, log_backup_script):
        """
        Sets the log_backup_script of this ProtectionJobRemoteScript.


        :param log_backup_script: The log_backup_script of this ProtectionJobRemoteScript.
    ...
    def remote_host(self):
        """
        Gets the remote_host of this ProtectionJobRemoteScript.


        :return: The remote_host of this ProtectionJobRemoteScript.
    ...
    def remote_host(self, remote_host):
        """
        Sets the remote_host of this ProtectionJobRemoteScript.


        :param remote_host: The remote_host of this ProtectionJobRemoteScript.
    ...
    def username(self):
        """
        Gets the username of this ProtectionJobRemoteScript.
        ...
        :return: The username of this ProtectionJobRemoteScript.
        :rtype: str
        """
    ...
    def username(self, username):
        """
        Sets the username of this ProtectionJobRemoteScript.
        Specifies the username that will be used to login to the remote host. For host type 'kLinux', it is expected that user has setup the password-less access. So only username field is required.

        :param username: The username of this ProtectionJobRemoteScript.
        :type: str
        """
