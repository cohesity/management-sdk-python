...
class SchedulingPolicy(object):
    ...
    def __init__(self, continuous_schedule=None, daily_schedule=None, monthly_schedule=None, periodicity=None):
        """
        SchedulingPolicy - a model defined in Swagger
    ...
    def continuous_schedule(self):
        """
        Gets the continuous_schedule of this SchedulingPolicy.


        :return: The continuous_schedule of this SchedulingPolicy.
    ...
    def continuous_schedule(self, continuous_schedule):
        """
        Sets the continuous_schedule of this SchedulingPolicy.


        :param continuous_schedule: The continuous_schedule of this SchedulingPolicy.
    ...
    def daily_schedule(self):
        """
        Gets the daily_schedule of this SchedulingPolicy.


        :return: The daily_schedule of this SchedulingPolicy.
    ...
    def daily_schedule(self, daily_schedule):
        """
        Sets the daily_schedule of this SchedulingPolicy.


        :param daily_schedule: The daily_schedule of this SchedulingPolicy.
    ...
    def monthly_schedule(self):
        """
        Gets the monthly_schedule of this SchedulingPolicy.


        :return: The monthly_schedule of this SchedulingPolicy.
    ...
    def monthly_schedule(self, monthly_schedule):
        """
        Sets the monthly_schedule of this SchedulingPolicy.


        :param monthly_schedule: The monthly_schedule of this SchedulingPolicy.
    ...
    def periodicity(self):
        """
        Gets the periodicity of this SchedulingPolicy.
        ...
        :return: The periodicity of this SchedulingPolicy.
        :rtype: str
        """
    ...
    def periodicity(self, periodicity):
        """
        Sets the periodicity of this SchedulingPolicy.
        Specifies how often to start new Job Runs of a Protection Job. 'kDaily' means new Job Runs start daily. 'kMonthly' means new Job Runs start monthly. 'kContinuous' means new Job Runs repetitively start at the beginning of the specified time interval (in hours or minutes). 'kOneOff' means this is an additional schedule.

        :param periodicity: The periodicity of this SchedulingPolicy.
        :type: str
        """
