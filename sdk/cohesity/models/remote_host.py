...
class RemoteHost(object):
    ...
    def __init__(self, address=None, type=None):
        """
        RemoteHost - a model defined in Swagger
    ...
    def address(self, address):
        """
        Sets the address of this RemoteHost.
        Specifies the address (IP, hostname or FQDN) of the remote host that will run the script.

        :param address: The address of this RemoteHost.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this RemoteHost.
        ...
        :return: The type of this RemoteHost.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this RemoteHost.
        Specifies the OS type of the remote host that will run the script. Currently only 'kLinux' is supported. 'kLinux' indicates the Linux operating system. 'kWindows' indicates the Microsoft Windows operating system.

        :param type: The type of this RemoteHost.
        :type: str
        """
