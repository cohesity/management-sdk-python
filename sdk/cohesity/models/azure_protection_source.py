...
class AzureProtectionSource(object):
    ...
    def __init__(self, host_type=None, ip_addresses=None, location=None, memory_mbytes=None, name=None, num_cores=None, resource_id=None, type=None):
        """
        AzureProtectionSource - a model defined in Swagger
    ...
    def host_type(self):
        """
        Gets the host_type of this AzureProtectionSource.
        ...
        :return: The host_type of this AzureProtectionSource.
        :rtype: str
        """
    ...
    def host_type(self, host_type):
        """
        Sets the host_type of this AzureProtectionSource.
        Specifies the OS type of the Protection Source of type 'kVirtualMachine' such as 'kWindows' or 'kLinux'. overrideDescription: true 'kLinux' indicates the Linux operating system. 'kWindows' indicates the Microsoft Windows operating system.

        :param host_type: The host_type of this AzureProtectionSource.
        :type: str
        """
    ...
    def ip_addresses(self):
        """
        Gets the ip_addresses of this AzureProtectionSource.


        :return: The ip_addresses of this AzureProtectionSource.
        :rtype: list[str]
        """
    ...
    def ip_addresses(self, ip_addresses):
        """
        Sets the ip_addresses of this AzureProtectionSource.


        :param ip_addresses: The ip_addresses of this AzureProtectionSource.
        :type: list[str]
        """
    ...
    def location(self):
        """
        Gets the location of this AzureProtectionSource.
        Specifies the physical location of the resource group.

        :return: The location of this AzureProtectionSource.
        :rtype: str
        """
    ...
    def location(self, location):
        """
        Sets the location of this AzureProtectionSource.
        Specifies the physical location of the resource group.

        :param location: The location of this AzureProtectionSource.
        :type: str
        """
    ...
    def memory_mbytes(self):
        """
        Gets the memory_mbytes of this AzureProtectionSource.
        Specifies the amount of memory in MegaBytes of the Azure resource of type 'kComputeOptions'.

        :return: The memory_mbytes of this AzureProtectionSource.
        :rtype: int
        """
    ...
    def memory_mbytes(self, memory_mbytes):
        """
        Sets the memory_mbytes of this AzureProtectionSource.
        Specifies the amount of memory in MegaBytes of the Azure resource of type 'kComputeOptions'.

        :param memory_mbytes: The memory_mbytes of this AzureProtectionSource.
        :type: int
        """
    ...
    def name(self):
        """
        Gets the name of this AzureProtectionSource.
        ...
        :return: The name of this AzureProtectionSource.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this AzureProtectionSource.
        Specifies the name of the Azure Object set by the Cloud Provider. If the provider did not set a name for the object, this field is not set.

        :param name: The name of this AzureProtectionSource.
        :type: str
        """
    ...
    def num_cores(self):
        """
        Gets the num_cores of this AzureProtectionSource.
        Specifies the number of CPU cores of the Azure resource of type 'kComputeOptions'.

        :return: The num_cores of this AzureProtectionSource.
        :rtype: int
        """
    ...
    def num_cores(self, num_cores):
        """
        Sets the num_cores of this AzureProtectionSource.
        Specifies the number of CPU cores of the Azure resource of type 'kComputeOptions'.

        :param num_cores: The num_cores of this AzureProtectionSource.
        :type: int
        """
    ...
    def resource_id(self):
        """
        Gets the resource_id of this AzureProtectionSource.
        Specifies the unique Id of the resource in Azure environment.

        :return: The resource_id of this AzureProtectionSource.
        :rtype: str
        """
    ...
    def resource_id(self, resource_id):
        """
        Sets the resource_id of this AzureProtectionSource.
        Specifies the unique Id of the resource in Azure environment.

        :param resource_id: The resource_id of this AzureProtectionSource.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this AzureProtectionSource.
        ...
        :return: The type of this AzureProtectionSource.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this AzureProtectionSource.
        Specifies the type of an Azure Protection Source Object such as 'kStorageContainer', 'kVirtualMachine', 'kVirtualNetwork', etc. Specifies the type of an Azure source entity. 'kSubscription' indicates a billing unit within Azure account. 'kResourceGroup' indicates a container that holds related resources. 'kVirtualMachine' indicates a Virtual Machine in Azure environment. 'kStorageAccount' represents a collection of storage containers. 'kStorageKey' indicates a key required to access the storage account. 'kStorageContainer' represents a storage container within a storage account. 'kStorageBlob' represents a storage blog within a storage container. 'kNetworkSecurityGroup' represents a network security group. 'kVirtualNetwork' represents a virtual network. 'kSubnet' represents a subnet within the virtual network. 'kComputeOptions' indicates the number of CPU cores and memory size available for a type of a Virtual Machine.

        :param type: The type of this AzureProtectionSource.
        :type: str
        """
