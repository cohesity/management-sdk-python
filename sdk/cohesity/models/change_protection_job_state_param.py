...
class ChangeProtectionJobStateParam(object):
    ...
    def __init__(self, pause=None):
        """
        ChangeProtectionJobStateParam - a model defined in Swagger
    ...
    def pause(self):
        """
        Gets the pause of this ChangeProtectionJobStateParam.
        ...
        :return: The pause of this ChangeProtectionJobStateParam.
        :rtype: bool
        """
        return self._pause
    ...
    def pause(self, pause):
        """
        Sets the pause of this ChangeProtectionJobStateParam.
        If true, the specified Protection Job is paused and no new Runs of the Job are started. Any Runs that were executing continue to run. If false and the Protection Job was in a paused state, the Protection Job resumes and new Runs are started according to the schedule defined in the associated Policy.

        :param pause: The pause of this ChangeProtectionJobStateParam.
        :type: bool
        """
