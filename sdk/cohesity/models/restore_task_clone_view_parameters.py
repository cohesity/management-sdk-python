...
class RestoreTaskCloneViewParameters(object):
    """
    ...
    def __init__(self, access_sids=None, description=None, enable_filer_audit_logging=None, enable_mixed_mode_permissions=None, enable_smb_access_based_enumeration=None, enable_smb_view_discovery=None, file_extension_filter=None, logical_quota=None, protocol_access=None, qos=None, smb_permissions_info=None, storage_policy_override=None, subnet_whitelist=None):
        """
        RestoreTaskCloneViewParameters - a model defined in Swagger
    ...
    def access_sids(self):
        """
        Gets the access_sids of this RestoreTaskCloneViewParameters.
        Specifies the list of security identifiers (SIDs) for the restricted Principals who have access to this View.

        :return: The access_sids of this RestoreTaskCloneViewParameters.
        :rtype: list[str]
        """
    ...
    def access_sids(self, access_sids):
        """
        Sets the access_sids of this RestoreTaskCloneViewParameters.
        Specifies the list of security identifiers (SIDs) for the restricted Principals who have access to this View.

        :param access_sids: The access_sids of this RestoreTaskCloneViewParameters.
        :type: list[str]
        """
    ...
    def description(self):
        """
        Gets the description of this RestoreTaskCloneViewParameters.
        Specifies an optional text description about the View.

        :return: The description of this RestoreTaskCloneViewParameters.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this RestoreTaskCloneViewParameters.
        Specifies an optional text description about the View.

        :param description: The description of this RestoreTaskCloneViewParameters.
        :type: str
        """
    ...
    def enable_filer_audit_logging(self):
        """
        Gets the enable_filer_audit_logging of this RestoreTaskCloneViewParameters.
        Specifies if Filer Audit Logging is enabled for this view.

        :return: The enable_filer_audit_logging of this RestoreTaskCloneViewParameters.
        :rtype: bool
        """
    ...
    def enable_filer_audit_logging(self, enable_filer_audit_logging):
        """
        Sets the enable_filer_audit_logging of this RestoreTaskCloneViewParameters.
        Specifies if Filer Audit Logging is enabled for this view.

        :param enable_filer_audit_logging: The enable_filer_audit_logging of this RestoreTaskCloneViewParameters.
        :type: bool
        """
    ...
    def enable_mixed_mode_permissions(self):
        """
        Gets the enable_mixed_mode_permissions of this RestoreTaskCloneViewParameters.
        If set, mixed mode (NFS and SMB) access is enabled for this view.

        :return: The enable_mixed_mode_permissions of this RestoreTaskCloneViewParameters.
        :rtype: bool
        """
    ...
    def enable_mixed_mode_permissions(self, enable_mixed_mode_permissions):
        """
        Sets the enable_mixed_mode_permissions of this RestoreTaskCloneViewParameters.
        If set, mixed mode (NFS and SMB) access is enabled for this view.

        :param enable_mixed_mode_permissions: The enable_mixed_mode_permissions of this RestoreTaskCloneViewParameters.
        :type: bool
        """
    ...
    def enable_smb_access_based_enumeration(self):
        """
        Gets the enable_smb_access_based_enumeration of this RestoreTaskCloneViewParameters.
        ...
        :return: The enable_smb_access_based_enumeration of this RestoreTaskCloneViewParameters.
        :rtype: bool
        """
    ...
    def enable_smb_access_based_enumeration(self, enable_smb_access_based_enumeration):
        """
        Sets the enable_smb_access_based_enumeration of this RestoreTaskCloneViewParameters.
        Specifies if access-based enumeration should be enabled. If 'true', only files and folders that the user has permissions to access are visible on the SMB share for that user.

        :param enable_smb_access_based_enumeration: The enable_smb_access_based_enumeration of this RestoreTaskCloneViewParameters.
        :type: bool
        """
    ...
    def enable_smb_view_discovery(self):
        """
        Gets the enable_smb_view_discovery of this RestoreTaskCloneViewParameters.
        If set, it enables discovery of view for SMB.

        :return: The enable_smb_view_discovery of this RestoreTaskCloneViewParameters.
        :rtype: bool
        """
    ...
    def enable_smb_view_discovery(self, enable_smb_view_discovery):
        """
        Sets the enable_smb_view_discovery of this RestoreTaskCloneViewParameters.
        If set, it enables discovery of view for SMB.

        :param enable_smb_view_discovery: The enable_smb_view_discovery of this RestoreTaskCloneViewParameters.
        :type: bool
        """
    ...
    def file_extension_filter(self):
        """
        Gets the file_extension_filter of this RestoreTaskCloneViewParameters.
        ...
        :return: The file_extension_filter of this RestoreTaskCloneViewParameters.
    ...
    def file_extension_filter(self, file_extension_filter):
        """
        Sets the file_extension_filter of this RestoreTaskCloneViewParameters.
        Optional filtering criteria that should be satisfied by all the files created in this view. It does not affect existing files.

        :param file_extension_filter: The file_extension_filter of this RestoreTaskCloneViewParameters.
    ...
    def logical_quota(self):
        """
        Gets the logical_quota of this RestoreTaskCloneViewParameters.


        :return: The logical_quota of this RestoreTaskCloneViewParameters.
    ...
    def logical_quota(self, logical_quota):
        """
        Sets the logical_quota of this RestoreTaskCloneViewParameters.


        :param logical_quota: The logical_quota of this RestoreTaskCloneViewParameters.
    ...
    def protocol_access(self):
        """
        Gets the protocol_access of this RestoreTaskCloneViewParameters.
        Specifies the supported Protocols for the View.

        :return: The protocol_access of this RestoreTaskCloneViewParameters.
        :rtype: str
        """
    ...
    def protocol_access(self, protocol_access):
        """
        Sets the protocol_access of this RestoreTaskCloneViewParameters.
        Specifies the supported Protocols for the View.

        :param protocol_access: The protocol_access of this RestoreTaskCloneViewParameters.
        :type: str
        """
    ...
    def qos(self):
        """
        Gets the qos of this RestoreTaskCloneViewParameters.
        Specifies the Quality of Service (QoS) Policy for the View.

        :return: The qos of this RestoreTaskCloneViewParameters.
        :rtype: QoS
        """
        return self._qos
    ...
    def qos(self, qos):
        """
        Sets the qos of this RestoreTaskCloneViewParameters.
        Specifies the Quality of Service (QoS) Policy for the View.

        :param qos: The qos of this RestoreTaskCloneViewParameters.
        :type: QoS
        """
    ...
    def smb_permissions_info(self):
        """
        Gets the smb_permissions_info of this RestoreTaskCloneViewParameters.
        Specifies the SMB permissions for the View.

        :return: The smb_permissions_info of this RestoreTaskCloneViewParameters.
    ...
    def smb_permissions_info(self, smb_permissions_info):
        """
        Sets the smb_permissions_info of this RestoreTaskCloneViewParameters.
        Specifies the SMB permissions for the View.

        :param smb_permissions_info: The smb_permissions_info of this RestoreTaskCloneViewParameters.
    ...
    def storage_policy_override(self):
        """
        Gets the storage_policy_override of this RestoreTaskCloneViewParameters.
        ...
        :return: The storage_policy_override of this RestoreTaskCloneViewParameters.
    ...
    def storage_policy_override(self, storage_policy_override):
        """
        Sets the storage_policy_override of this RestoreTaskCloneViewParameters.
        Specifies if inline deduplication and compression settings inherited from the Storage Domain (View Box) should be disabled for this View.

        :param storage_policy_override: The storage_policy_override of this RestoreTaskCloneViewParameters.
    ...
    def subnet_whitelist(self):
        """
        Gets the subnet_whitelist of this RestoreTaskCloneViewParameters.
        ...
        :return: The subnet_whitelist of this RestoreTaskCloneViewParameters.
        :rtype: list[Subnet]
        """
    ...
    def subnet_whitelist(self, subnet_whitelist):
        """
        Sets the subnet_whitelist of this RestoreTaskCloneViewParameters.
        Specifies a list of Subnets with IP addresses that have permissions to access the View. (Overrides the Subnets specified at the global Cohesity Cluster level.)

        :param subnet_whitelist: The subnet_whitelist of this RestoreTaskCloneViewParameters.
        :type: list[Subnet]
        """
