...
class CreateViewBoxParamsPhysicalQuota(object):
    """
    ...
    def __init__(self, alert_limit=None, hard_limit=None, alert_limit_bytes=None, alert_threshold_percentage=None, hard_limit_bytes=None):
        """
        CreateViewBoxParamsPhysicalQuota - a model defined in Swagger
    ...
    def alert_limit(self):
        """
        Gets the alert_limit of this CreateViewBoxParamsPhysicalQuota.
        AlertLimitBytes converted to GiB format for report purposes.

        :return: The alert_limit of this CreateViewBoxParamsPhysicalQuota.
        :rtype: str
        """
    ...
    def alert_limit(self, alert_limit):
        """
        Sets the alert_limit of this CreateViewBoxParamsPhysicalQuota.
        AlertLimitBytes converted to GiB format for report purposes.

        :param alert_limit: The alert_limit of this CreateViewBoxParamsPhysicalQuota.
        :type: str
        """
    ...
    def hard_limit(self):
        """
        Gets the hard_limit of this CreateViewBoxParamsPhysicalQuota.
        HardLimitBytes converted to GiB format for report purposes.

        :return: The hard_limit of this CreateViewBoxParamsPhysicalQuota.
        :rtype: str
        """
    ...
    def hard_limit(self, hard_limit):
        """
        Sets the hard_limit of this CreateViewBoxParamsPhysicalQuota.
        HardLimitBytes converted to GiB format for report purposes.

        :param hard_limit: The hard_limit of this CreateViewBoxParamsPhysicalQuota.
        :type: str
        """
    ...
    def alert_limit_bytes(self):
        """
        Gets the alert_limit_bytes of this CreateViewBoxParamsPhysicalQuota.
        ...
        :return: The alert_limit_bytes of this CreateViewBoxParamsPhysicalQuota.
        :rtype: int
        """
    ...
    def alert_limit_bytes(self, alert_limit_bytes):
        """
        Sets the alert_limit_bytes of this CreateViewBoxParamsPhysicalQuota.
        Specifies if an alert should be triggered when the usage of this resource exceeds this quota limit. This limit is optional and is specified in bytes. If no value is specified, there is no limit.

        :param alert_limit_bytes: The alert_limit_bytes of this CreateViewBoxParamsPhysicalQuota.
        :type: int
        """
    ...
    def alert_threshold_percentage(self):
        """
        Gets the alert_threshold_percentage of this CreateViewBoxParamsPhysicalQuota.
        ...
        :return: The alert_threshold_percentage of this CreateViewBoxParamsPhysicalQuota.
        :rtype: int
        """
    ...
    def alert_threshold_percentage(self, alert_threshold_percentage):
        """
        Sets the alert_threshold_percentage of this CreateViewBoxParamsPhysicalQuota.
        Supported only for user quota policy. Specifies when the uage goes above an alert threshold percentage which is: HardLimitBytes * AlertThresholdPercentage, eg: 80% of HardLimitBytes Can only be set if HardLimitBytes is set. Cannot be set if AlertLimitBytes is already set.

        :param alert_threshold_percentage: The alert_threshold_percentage of this CreateViewBoxParamsPhysicalQuota.
        :type: int
        """
    ...
    def hard_limit_bytes(self):
        """
        Gets the hard_limit_bytes of this CreateViewBoxParamsPhysicalQuota.
        ...
        :return: The hard_limit_bytes of this CreateViewBoxParamsPhysicalQuota.
        :rtype: int
        """
    ...
    def hard_limit_bytes(self, hard_limit_bytes):
        """
        Sets the hard_limit_bytes of this CreateViewBoxParamsPhysicalQuota.
        Specifies an optional quota limit on the usage allowed for this resource. This limit is specified in bytes. If no value is specified, there is no limit.

        :param hard_limit_bytes: The hard_limit_bytes of this CreateViewBoxParamsPhysicalQuota.
        :type: int
        """
