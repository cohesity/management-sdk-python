...
class ClusterStatsLocalUsagePerfStats(object):
    """
    ...
    def __init__(self, data_in_bytes=None, data_in_bytes_after_reduction=None, min_usable_physical_capacity_bytes=None, num_bytes_read=None, num_bytes_written=None, physical_capacity_bytes=None, read_ios=None, read_latency_msecs=None, system_capacity_bytes=None, system_usage_bytes=None, total_physical_raw_usage_bytes=None, total_physical_usage_bytes=None, write_ios=None, write_latency_msecs=None):
        """
        ClusterStatsLocalUsagePerfStats - a model defined in Swagger
    ...
    def data_in_bytes(self):
        """
        Gets the data_in_bytes of this ClusterStatsLocalUsagePerfStats.
        Data brought into the cluster. This is the usage before data reduction if we ignore the zeroes and effects of cloning.

        :return: The data_in_bytes of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def data_in_bytes(self, data_in_bytes):
        """
        Sets the data_in_bytes of this ClusterStatsLocalUsagePerfStats.
        Data brought into the cluster. This is the usage before data reduction if we ignore the zeroes and effects of cloning.

        :param data_in_bytes: The data_in_bytes of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def data_in_bytes_after_reduction(self):
        """
        Gets the data_in_bytes_after_reduction of this ClusterStatsLocalUsagePerfStats.
        Morphed Usage before data is replicated to other nodes as per RF or Erasure Coding policy.

        :return: The data_in_bytes_after_reduction of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def data_in_bytes_after_reduction(self, data_in_bytes_after_reduction):
        """
        Sets the data_in_bytes_after_reduction of this ClusterStatsLocalUsagePerfStats.
        Morphed Usage before data is replicated to other nodes as per RF or Erasure Coding policy.

        :param data_in_bytes_after_reduction: The data_in_bytes_after_reduction of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def min_usable_physical_capacity_bytes(self):
        """
        Gets the min_usable_physical_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        ...
        :return: The min_usable_physical_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def min_usable_physical_capacity_bytes(self, min_usable_physical_capacity_bytes):
        """
        Sets the min_usable_physical_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        Specifies the minimum usable capacity available after erasure coding or RF. This will only be populated for cluster. If a cluster has multiple Domains (View Boxes) with different RF or erasure coding, this metric will be computed using the scheme that will provide least saving.

        :param min_usable_physical_capacity_bytes: The min_usable_physical_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def num_bytes_read(self):
        """
        Gets the num_bytes_read of this ClusterStatsLocalUsagePerfStats.
        Provides the total number of bytes read in the last 30 seconds.

        :return: The num_bytes_read of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def num_bytes_read(self, num_bytes_read):
        """
        Sets the num_bytes_read of this ClusterStatsLocalUsagePerfStats.
        Provides the total number of bytes read in the last 30 seconds.

        :param num_bytes_read: The num_bytes_read of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def num_bytes_written(self):
        """
        Gets the num_bytes_written of this ClusterStatsLocalUsagePerfStats.
        Provides the total number of bytes written in the last 30 second.

        :return: The num_bytes_written of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def num_bytes_written(self, num_bytes_written):
        """
        Sets the num_bytes_written of this ClusterStatsLocalUsagePerfStats.
        Provides the total number of bytes written in the last 30 second.

        :param num_bytes_written: The num_bytes_written of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def physical_capacity_bytes(self):
        """
        Gets the physical_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        Provides the total physical capacity in bytes as computed by the Cohesity Cluster.

        :return: The physical_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def physical_capacity_bytes(self, physical_capacity_bytes):
        """
        Sets the physical_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        Provides the total physical capacity in bytes as computed by the Cohesity Cluster.

        :param physical_capacity_bytes: The physical_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def read_ios(self):
        """
        Gets the read_ios of this ClusterStatsLocalUsagePerfStats.
        Provides the number of Read IOs that occurred in the last 30 seconds.

        :return: The read_ios of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def read_ios(self, read_ios):
        """
        Sets the read_ios of this ClusterStatsLocalUsagePerfStats.
        Provides the number of Read IOs that occurred in the last 30 seconds.

        :param read_ios: The read_ios of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def read_latency_msecs(self):
        """
        Gets the read_latency_msecs of this ClusterStatsLocalUsagePerfStats.
        Provides the Read latency in milliseconds for the Read IOs that occurred during the last 30 seconds.

        :return: The read_latency_msecs of this ClusterStatsLocalUsagePerfStats.
        :rtype: float
        """
    ...
    def read_latency_msecs(self, read_latency_msecs):
        """
        Sets the read_latency_msecs of this ClusterStatsLocalUsagePerfStats.
        Provides the Read latency in milliseconds for the Read IOs that occurred during the last 30 seconds.

        :param read_latency_msecs: The read_latency_msecs of this ClusterStatsLocalUsagePerfStats.
        :type: float
        """
    ...
    def system_capacity_bytes(self):
        """
        Gets the system_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        Provides the total available capacity as computed by the Linux 'statfs' command.

        :return: The system_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def system_capacity_bytes(self, system_capacity_bytes):
        """
        Sets the system_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        Provides the total available capacity as computed by the Linux 'statfs' command.

        :param system_capacity_bytes: The system_capacity_bytes of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def system_usage_bytes(self):
        """
        Gets the system_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        ...
        :return: The system_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def system_usage_bytes(self, system_usage_bytes):
        """
        Sets the system_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        Provides the usage of bytes, as computed by the Linux 'statfs' command, after the size of the data is reduced by change-block tracking, compression and deduplication.

        :param system_usage_bytes: The system_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def total_physical_raw_usage_bytes(self):
        """
        Gets the total_physical_raw_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        ...
        :return: The total_physical_raw_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def total_physical_raw_usage_bytes(self, total_physical_raw_usage_bytes):
        """
        Sets the total_physical_raw_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        Provides the usage of bytes, as computed by the Cohesity Cluster, before the size of the data is reduced by change-block tracking, compression and deduplication.

        :param total_physical_raw_usage_bytes: The total_physical_raw_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def total_physical_usage_bytes(self):
        """
        Gets the total_physical_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        ...
        :return: The total_physical_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def total_physical_usage_bytes(self, total_physical_usage_bytes):
        """
        Sets the total_physical_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        Provides the total capacity, as computed by the Cohesity Cluster, after the size of the data has been reduced by change-block tracking, compression and deduplication.

        :param total_physical_usage_bytes: The total_physical_usage_bytes of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def write_ios(self):
        """
        Gets the write_ios of this ClusterStatsLocalUsagePerfStats.
        Provides the number of Write IOs that occurred in the last 30 seconds.

        :return: The write_ios of this ClusterStatsLocalUsagePerfStats.
        :rtype: int
        """
    ...
    def write_ios(self, write_ios):
        """
        Sets the write_ios of this ClusterStatsLocalUsagePerfStats.
        Provides the number of Write IOs that occurred in the last 30 seconds.

        :param write_ios: The write_ios of this ClusterStatsLocalUsagePerfStats.
        :type: int
        """
    ...
    def write_latency_msecs(self):
        """
        Gets the write_latency_msecs of this ClusterStatsLocalUsagePerfStats.
        Provides the Write latency in milliseconds for the Write IOs that occurred during the last 30 seconds.

        :return: The write_latency_msecs of this ClusterStatsLocalUsagePerfStats.
        :rtype: float
        """
    ...
    def write_latency_msecs(self, write_latency_msecs):
        """
        Sets the write_latency_msecs of this ClusterStatsLocalUsagePerfStats.
        Provides the Write latency in milliseconds for the Write IOs that occurred during the last 30 seconds.

        :param write_latency_msecs: The write_latency_msecs of this ClusterStatsLocalUsagePerfStats.
        :type: float
        """
