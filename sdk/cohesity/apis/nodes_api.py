...
class NodesApi(object):
    ...
    def get_node_by_id(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_node_by_id(id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_node_by_id_with_http_info(id, **kwargs)
        else:
            (data) = self.get_node_by_id_with_http_info(id, **kwargs)
            return data

    def get_node_by_id_with_http_info(self, id, **kwargs):
        """
        List details about a single node.
        Returns the Node corresponding to the specified Node Id.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_node_by_id_with_http_info(id, callback=callback_function)
        ...
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_node_by_id`")

        resource_path = '/public/nodes/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def get_nodes_with_http_info(self, **kwargs):
        ...
        resource_path = '/public/nodes'.replace('{format}', 'json')
        path_params = {}
