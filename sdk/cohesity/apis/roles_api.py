...
class RolesApi(object):
    ...
    def create_role(self, **kwargs):
        ...
        :param RoleCreateParameters body: Request to create a new custom Role.
        :return: Role
    ...
    def create_role_with_http_info(self, **kwargs):
        ...
        resource_path = '/public/roles'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_roles(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_roles(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param RoleDeleteParameters body: Request to delete one or more Roles.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_roles_with_http_info(**kwargs)
        else:
            (data) = self.delete_roles_with_http_info(**kwargs)
            return data

    def delete_roles_with_http_info(self, **kwargs):
        """
        Delete one or more custom Roles.
        Returns Success if all the specified Roles are deleted.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_roles_with_http_info(callback=callback_function)
    ...
    def get_roles(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str name: Specifies the name of the role.
        :return: list[Role]
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_role(self, name, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_role(name, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str name: Specifies the name of the role to update. (required)
        :param RoleUpdateParameters body: Request to update a custom role.
        :return: Role
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_role_with_http_info(name, **kwargs)
        else:
            (data) = self.update_role_with_http_info(name, **kwargs)
            return data

    def update_role_with_http_info(self, name, **kwargs):
        """
        Update a user-defined custom role.
        For example, you could update the privileges assigned to a Role. Returns the updated role.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_role_with_http_info(name, callback=callback_function)
        ...
        if ('name' not in params) or (params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `update_role`")

        resource_path = '/public/roles/{name}'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
