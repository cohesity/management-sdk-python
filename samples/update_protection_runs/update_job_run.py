...
# --start_time=2019-2-31 --end_time=2019-7-29 --extend=<num-of-days>
#
...
from cohesity_management_sdk.models.type_run_job_snapshot_target_enum import TypeRunJobSnapshotTargetEnum
from cohesity_management_sdk.models.run_job_snapshot_target import RunJobSnapshotTarget
from cohesity_management_sdk.models.update_protection_job_run import UpdateProtectionJobRun
from cohesity_management_sdk.models.update_protection_job_runs_param import UpdateProtectionJobRunsParam
...
def main(args):
    ...
    start_time = convert_to_epoch(args.start_time.split('-')) + MILLISECONDS
    end_time = convert_to_epoch(args.end_time.split('-'), True) + MILLISECONDS

    job_id, cluster_id, incarnation_id = get_pro_id(args.job_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--job_name", help="Protection Job Name",
                        required=True)
    parser.add_argument("--start_time", help="Format YEAR-MM-DD",
                        required=True)
